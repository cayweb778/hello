...
@AllArgsConstructor
@Table("acc_carry_over_entry_formula" )
@ApiModel(value="结转分录公式",description="结转分录公式表")
public class AccCarryOverEntryFormula implements java.io.Serializable {
    ...
    public AccCarryOverEntryFormula() {
    }
