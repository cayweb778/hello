...
@Table("audit_sys_user")
@ApiModel(value = "user对象", description = "user对象")
public class GroupAuditUser implements Serializable {
    ...
    @ApiModelProperty(value = "0 修改 1删除键", hidden = true)
    private String optMethod;
    @ApiModelProperty(value = "账户", hidden = true)
