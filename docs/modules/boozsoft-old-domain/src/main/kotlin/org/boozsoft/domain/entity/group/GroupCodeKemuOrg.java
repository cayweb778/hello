...
@AllArgsConstructor
@NoArgsConstructor
@Table ("_app_group_code_kemu_org" )
@ApiModel(value="code_kemu: table",description="code_kemu: table")
public class GroupCodeKemuOrg {
	...
	@ApiModelProperty(value = "所属组织唯一码", position = 21)
