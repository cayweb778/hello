...
@Table("_app_origin_report_template")
@Data
public class OriginReportTemplate {
    ...
    private List<OriginReportTemplateColumn> table;
    @Transient
    @ApiModelProperty(value = "财务报表模板栏目", hidden = true)
    private List<OriginReportTemplateColumn> zcTable;
    @Transient
    @ApiModelProperty(value = "财务报表模板栏目", hidden = true)
    private List<OriginReportTemplateColumn> fzTable;
