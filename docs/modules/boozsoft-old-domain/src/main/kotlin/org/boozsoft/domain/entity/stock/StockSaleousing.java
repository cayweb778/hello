...
@Data
@Table ( "stock_saleousing" )
@Accessors(chain = true)
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="出库单主表",description="出库单主表")
public class StockSaleousing implements Serializable {
	@Id
	...
	@ApiModelProperty(value = "完成结算1",hidden = true)
	private String jiesuanStatus;
	@ApiModelProperty(value = "完成开票1",hidden = true)
	private String fapiaoStatus;
	@ApiModelProperty(value = "完成入库1",hidden = true)
	private String xiaohuoStatus;
	@ApiModelProperty(value = "完成质检1",hidden = true)
	private String jijianStatus;
	@ApiModelProperty(value = "完成物流1",hidden = true)
	private String wuliuStatus;
	@ApiModelProperty(value = "完成出库1",hidden = true)
	private String chukuStatus;
	@ApiModelProperty(value = "完成退货1",hidden = true)
	...
	@ApiModelProperty(value = "复核时间",hidden = true)
