...
@Data
@Table ( "stock_warehousings" )
@Accessors(chain = true)
@ApiModel(value="入库单子表",description="入库单子表")
public class StockWarehousings {
	...
	@ApiModelProperty(value = "客户供应商唯一码",hidden = true)
	...
	private String isum;
	@ApiModelProperty(value = "折扣金额（4位小数点",hidden = true)
	...
	@ApiModelProperty(value = "累计到货数量",hidden = true)
	...
	@ApiModelProperty(value = "到货日期",hidden = true)
	...
	@Transient
	private String oldSubQuantity1;
	@Transient
	private String oldSubQuantity2;
	@Transient
	private String oldTaxprice;
	@Transient
	private String oldIsum;
	@Transient
	private String oldCinvode;
	@Transient
	private String oldBatchId;
	@Transient
	private String oldCnumber;
