...
@RestController
@RequestMapping("/sys/faAssetGroup")
public class FaAssetGroupController {

    @Autowired
    private FaAssetGroupRepository groupBudgetSourceRepository;
    ...
    public Mono save(@RequestBody FaAssetGroup object){
    ...
    public Mono delete(@RequestBody FaAssetGroup object){
    ...
    public Mono editFlag(@RequestBody FaAssetGroup object) {
        String time = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date());
    ...
    @Transactional
    public Mono excel(@RequestBody List<FaAssetGroup> object){
