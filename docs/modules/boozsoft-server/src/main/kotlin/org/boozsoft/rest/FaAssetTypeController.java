...
@RestController
@RequestMapping("/sys/faAssetType")
public class FaAssetTypeController {

    @Autowired
    private FaAssetTypeRepository groupExpenditureClassRepository;

    @Autowired
    private FaPropertyRepository faPropertyRepository;

    @Autowired
    private FaZhejiuMethodRepository faZhejiuMethodRepository;

    @Autowired
    private SysUnitOfMeaRepository sysUnitOfMeaTypeRepository;
...
//                    .map(list->TreeUtils.castTreeList(list,GroupExpenditureClassVo.class))
    ...
    public Mono save(@RequestBody  FaAssetType object){
        ...
        //有上级是末级时
        Mono<FaAssetType> sysDeptClassMono = null;
    ...
    public Mono delete(@RequestBody  FaAssetType object) {
    ...
    public Mono editFlag(@RequestBody FaAssetType object) {
    ...
    @Transactional
    public Mono excel(@RequestBody List<FaAssetType> object){
