...
@RestController
@RequestMapping("/sys/faLocatin")
public class FaLocatinController {

    @Autowired
    private FaLocationRepository groupExpenditureClassRepository;
...
//                    .map(list->TreeUtils.castTreeList(list,GroupExpenditureClassVo.class))
    ...
    public Mono save(@RequestBody  FaLocation object){
        ...
        //有上级是末级时
        Mono< FaLocation> sysDeptClassMono = null;
    ...
    public Mono delete(@RequestBody  FaLocation object) {
    ...
    public Mono editFlag(@RequestBody FaLocation object) {
    ...
    @Transactional
    public Mono excel(@RequestBody List<FaLocation> object){
