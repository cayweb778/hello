...
@RestController
@RequestMapping("/sys/faUsageStatus")
public class FaUsageStatusController {

    @Autowired
    private FaUsageStatusRepository groupExpenditureClassRepository;
...
//                    .map(list->TreeUtils.castTreeList(list,GroupExpenditureClassVo.class))
    ...
    public Mono save(@RequestBody  FaUsageStatus object){
        ...
        //有上级是末级时
        Mono<FaUsageStatus> sysDeptClassMono = null;
    ...
    public Mono delete(@RequestBody  FaUsageStatus object) {
    ...
    public Mono editFlag(@RequestBody FaUsageStatus object) {
    ...
    @Transactional
    public Mono excel(@RequestBody List<FaUsageStatus> object){
