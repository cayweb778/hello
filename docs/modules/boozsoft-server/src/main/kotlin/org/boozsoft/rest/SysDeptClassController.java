...
import org.boozsoft.repo.SysDeptClassRepository;
import org.boozsoft.repo.group.GroupSysDeptClassRepository;
...
@RestController
@RequestMapping("/sys/deptClass")
public class SysDeptClassController {

    @Autowired
    private SysDeptClassRepository groupExpenditureClassRepository;

    @Autowired
    private GroupSysDeptClassRepository groupRepository;
...
//                    .map(list->TreeUtils.castTreeList(list,GroupExpenditureClassVo.class))
    ...
    public Mono save(@RequestBody SysDeptClass object){
        ...
        //有上级是末级时
        Mono<SysDeptClass> sysDeptClassMono = null;
    ...
    public Mono delete(@RequestBody SysDeptClass object) {
    ...
    public Mono editFlag(@RequestBody SysDeptClass object) {
    ...
    @Transactional
    public Mono excel(@RequestBody List<SysDeptClass> object){
    ...
    public Mono introduceData(@RequestBody List<GroupSysDeptClass> ids){
        return Mono.just(ids)
                .flatMap(list->{
                    List<SysDeptClass> l =  new ArrayList<>();
                    list.forEach(v->{
                        SysDeptClass b =  new SysDeptClass();
