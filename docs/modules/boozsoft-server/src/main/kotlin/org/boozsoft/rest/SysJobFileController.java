...
@RestController
@RequestMapping("/sys/jobfile")
public class SysJobFileController {

    @Autowired
    private SysJobFileRepository sysJobFileRepository;
    @Autowired
    private SysJobTypeRepository sysJobTypeRepository;
...
//                    .map(list->TreeUtils.castTreeList(list,GroupExpenditureClassVo.class))
    ...
    public Mono save(@RequestBody SysJobFile object){
    ...
    @ApiOperation(value = "新增或修改", notes = "传入code")
    public Mono saveJobType(@RequestBody SysJobType object){
        ...
        //有上级是末级时
        Mono<SysJobType> sysDeptClassMono = null;
    ...
    public Mono delete(@RequestBody SysJobFile object) {
    ...
    public Mono editFlag(@RequestBody SysJobFile object) {
    ...
    @Transactional
    public Mono excel(@RequestBody List<SysJobFile> object){
