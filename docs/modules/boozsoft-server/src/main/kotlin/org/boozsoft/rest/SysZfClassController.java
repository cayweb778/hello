...
import org.boozsoft.repo.SysZfClassRepository;
...
@RestController
@RequestMapping("/sys/zfClass")
public class SysZfClassController {

    @Autowired
    private SysZfClassRepository groupExpenditureClassRepository;

    @Autowired
    private GroupSysZfClassRepository groupRepository;
...
//                    .map(list->TreeUtils.castTreeList(list,GroupExpenditureClassVo.class))
    ...
    public Mono save(@RequestBody SysZfClass object){
        ...
        //有上级是末级时
        Mono<SysZfClass> sysDeptClassMono = null;
    ...
    public Mono delete(@RequestBody SysZfClass object) {
    ...
    public Mono editFlag(@RequestBody SysZfClass object) {
    ...
    @Transactional
    public Mono excel(@RequestBody List<SysZfClass> object){
    ...
    public Mono introduceData(@RequestBody List<GroupSysZfClass> ids){
        return Mono.just(ids)
                .flatMap(list->{
                    List<SysZfClass> l =  new ArrayList<>();
                    list.forEach(v->{
                        SysZfClass b =  new SysZfClass();
