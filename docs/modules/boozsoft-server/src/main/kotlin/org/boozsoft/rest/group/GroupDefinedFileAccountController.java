...
import org.boozsoft.repo.group.GroupDefinedFileAccountRepository;
...
@RestController
@RequestMapping("/groupDefinedFileAccount")
public class GroupDefinedFileAccountController {

    @Autowired
    GroupDefinedFileAccountRepository repository;
    ...
    public Mono save(@RequestBody GroupDefinedFileAccount object) {
    ...
    @ApiOperation(value = "新增或修改", notes = "传入code")
    public Mono saveList(@RequestBody List<GroupDefinedFileAccount> object) {
