...
import org.boozsoft.repo.group.GroupDefinedFileRepository;
...
@RestController
@RequestMapping("/groupDefinedFile")
public class GroupDefinedFileController {

    @Autowired
    GroupDefinedFileRepository definedFileRepository;
    ...
    public Mono save(@RequestBody GroupDefinedFile object) {
    ...
    public Mono delete(@RequestBody GroupDefinedFile object){
    ...
    public Mono deleteList(@RequestBody List<GroupDefinedFile> object){
    ...
    public Mono editByFlag(@RequestBody GroupDefinedFile object) {
    ...
    @Transactional
    public Mono excel(@RequestBody List<GroupDefinedFile> object){
