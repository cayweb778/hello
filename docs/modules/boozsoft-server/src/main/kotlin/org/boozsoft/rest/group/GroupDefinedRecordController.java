...
import org.boozsoft.repo.group.GroupDefinedRecordRepository;
...
@RestController
@RequestMapping("/groupDefinedRecord")
public class GroupDefinedRecordController {

    @Autowired
    GroupDefinedRecordRepository definedRecordRepository;
    ...
    public Mono save(@RequestBody GroupDefinedRecord object) {
    ...
    public Mono delete(@RequestBody GroupDefinedRecord object){
    ...
    public Mono deleteList(@RequestBody List<GroupDefinedRecord> object){
    ...
    public Mono editByFlag(@RequestBody GroupDefinedRecord object) {
    ...
    @Transactional
    public Mono excel(@RequestBody List<GroupDefinedRecord> object){
