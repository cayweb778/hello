...
@RestController
@RequestMapping("/group/expenditureClass")
public class GroupExpenditureClassController {

    @Autowired
    private GroupExpenditureClassRepository groupExpenditureClassRepository;
...
//                    .map(list->TreeUtils.castTreeList(list,GroupExpenditureClassVo.class))
    ...
    public Mono save(@RequestBody GroupExpenditureClass object){
        ...
        //有上级是末级时
        Mono<GroupExpenditureClass> sysDeptClassMono = null;
    ...
    public Mono delete(@RequestBody GroupExpenditureClass object) {
    ...
    public Mono editFlag(@RequestBody GroupExpenditureClass object) {
    ...
    @Transactional
    public Mono excel(@RequestBody List<GroupExpenditureClass> object){
