...
import org.boozsoft.repo.FaAssetGroupRepository;
import org.boozsoft.repo.group.GroupFaAssetGroupRepository;
...
@RestController
@RequestMapping("/group/faAssetGroup")
public class GroupFaAssetGroupController{

    @Autowired
    private GroupFaAssetGroupRepository groupBudgetSourceRepository;
    ...
    public Mono save(@RequestBody GroupFaAssetGroup object){
    ...
    public Mono delete(@RequestBody GroupFaAssetGroup object){
    ...
    public Mono editFlag(@RequestBody GroupFaAssetGroup object) {
        String time = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date());
    ...
    @Transactional
    public Mono excel(@RequestBody List<GroupFaAssetGroup> object){
