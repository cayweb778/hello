...
import org.boozsoft.repo.FaLocationRepository;
import org.boozsoft.repo.group.GroupFaLocationRepository;
...
@RestController
@RequestMapping("/group/faLocatin")
public class GroupFaLocatinController {

    @Autowired
    private GroupFaLocationRepository groupExpenditureClassRepository;
...
//                    .map(list->TreeUtils.castTreeList(list,GroupExpenditureClassVo.class))
    ...
    public Mono save(@RequestBody GroupFaLocation object){
        ...
        //有上级是末级时
        Mono< GroupFaLocation> sysDeptClassMono = null;
    ...
    public Mono delete(@RequestBody  GroupFaLocation object) {
    ...
    public Mono editFlag(@RequestBody GroupFaLocation object) {
    ...
    @Transactional
    public Mono excel(@RequestBody List<GroupFaLocation> object){
