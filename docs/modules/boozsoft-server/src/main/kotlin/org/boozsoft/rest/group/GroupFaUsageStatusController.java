...
import org.boozsoft.repo.FaUsageStatusRepository;
import org.boozsoft.repo.group.GroupFaUsageStatusRepository;
...
@RestController
@RequestMapping("/group/faUsageStatus")
public class GroupFaUsageStatusController {

    @Autowired
    private GroupFaUsageStatusRepository groupExpenditureClassRepository;
...
//                    .map(list->TreeUtils.castTreeList(list,GroupExpenditureClassVo.class))
    ...
    public Mono save(@RequestBody  GroupFaUsageStatus object){
        ...
        //有上级是末级时
        Mono<GroupFaUsageStatus> sysDeptClassMono = null;
    ...
    public Mono delete(@RequestBody  GroupFaUsageStatus object) {
    ...
    public Mono editFlag(@RequestBody GroupFaUsageStatus object) {
    ...
    @Transactional
    public Mono excel(@RequestBody List<GroupFaUsageStatus> object){
