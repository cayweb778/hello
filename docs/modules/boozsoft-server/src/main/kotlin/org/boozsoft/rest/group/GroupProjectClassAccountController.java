...
import org.boozsoft.repo.group.GroupProjectClassAccountRepository;
...
@RestController
@RequestMapping("/groupProjectClassAccount")
public class GroupProjectClassAccountController {

    @Autowired
    GroupProjectClassAccountRepository repository;
    ...
    public Mono save(@RequestBody GroupProjectClassAccount object) {
    ...
    @ApiOperation(value = "新增或修改", notes = "传入code")
    public Mono saveList(@RequestBody List<GroupProjectClassAccount> object) {
