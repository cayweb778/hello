...
import org.boozsoft.repo.group.GroupProjectItemAccountRepository;
...
@RestController
@RequestMapping("/groupProjectItemAccount")
public class GroupProjectItemAccountController {

    @Autowired
    GroupProjectItemAccountRepository repository;
    ...
    public Mono save(@RequestBody GroupProjectItemAccount object) {
    ...
    @ApiOperation(value = "新增或修改", notes = "传入code")
    public Mono saveList(@RequestBody List<GroupProjectItemAccount> object) {
