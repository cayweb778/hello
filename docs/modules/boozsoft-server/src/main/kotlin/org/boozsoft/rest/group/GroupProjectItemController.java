...
@RestController
@RequestMapping("/groupProjectItem")
public class GroupProjectItemController {

    @Autowired
    GroupProjectItemRepository projectItemRepository;
    ...
    public Mono save(@RequestBody GroupProjectItem object) {
    ...
    public Mono delete(@RequestBody GroupProjectItem object){
    ...
    public Mono deleteList(@RequestBody List<GroupProjectItem> object){
    ...
    public Mono editByFlag(@RequestBody GroupProjectItem object) {
    ...
    @Transactional
    public Mono excel(@RequestBody List<GroupProjectItem> object){
