...
@RestController
@RequestMapping("/group/deptClass")
public class GroupSysDeptClassController {

    @Autowired
    private GroupSysDeptClassRepository groupExpenditureClassRepository;
...
//                    .map(list->TreeUtils.castTreeList(list,GroupExpenditureClassVo.class))
    ...
    public Mono save(@RequestBody GroupSysDeptClass object){
        ...
        //有上级是末级时
        Mono<GroupSysDeptClass> sysDeptClassMono = null;
    ...
    public Mono delete(@RequestBody GroupSysDeptClass object) {
    ...
    public Mono editFlag(@RequestBody GroupSysDeptClass object) {
    ...
    @Transactional
    public Mono excel(@RequestBody List<GroupSysDeptClass> object){
