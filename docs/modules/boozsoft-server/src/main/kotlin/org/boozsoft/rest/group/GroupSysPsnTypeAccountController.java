...
import org.boozsoft.repo.group.GroupSysPsnTypeAccountRepository;
...
@RestController
@RequestMapping("/groupSysPsnTypeAccount")
public class GroupSysPsnTypeAccountController {

    @Autowired
    GroupSysPsnTypeAccountRepository repository;
    ...
    public Mono save(@RequestBody GroupSysPsnTypeAccount object) {
    ...
    @ApiOperation(value = "新增或修改", notes = "传入code")
    public Mono saveList(@RequestBody List<GroupSysPsnTypeAccount> object) {
