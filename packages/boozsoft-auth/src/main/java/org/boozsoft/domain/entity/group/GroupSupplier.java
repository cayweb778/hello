...
@AllArgsConstructor
@NoArgsConstructor
@Table ("_app_group_supplier" )
@ApiModel(value="系统供应商信息表",description="系统供应商信息表")
public class GroupSupplier {
	...
	@ApiModelProperty(value = "供应商编码（不允许重复）", position = 2)
	private String custCode;

	@ApiModelProperty(value = "供应商全称（不允许重复）", position = 3)
	private String custName;

	@ApiModelProperty(value = "供应商简称（不允许重复）", position = 4)
	...
	@ApiModelProperty(value = "0内部供应商/1外部供应商", position = 33)
	...
	@Transient
	private String assignFlag; // 集团供应商分配表引入状态,0未引入|1已引入
