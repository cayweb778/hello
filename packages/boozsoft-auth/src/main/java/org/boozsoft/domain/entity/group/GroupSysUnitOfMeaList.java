...
@AllArgsConstructor
@NoArgsConstructor
@Table ("_app_group_sys_unit_of_mea_list" )
@ApiModel(value="多计量单位关联",description="_app_group_sys_unit_of_mea_list: table")
public class GroupSysUnitOfMeaList {
	...
	@ApiModelProperty(value = "换算类型", position = 3)
