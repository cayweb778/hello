...
@Data
@Table ("_app_origin_supplier_class" )
@ApiModel(value="供应商分类",description="供应商分类")
@NoArgsConstructor
public class OrgSupplierClass {
	...
	public OrgSupplierClass(String uniqueCustclass, String cusClass, String cusClassGrade, String parentId, String cusCclassName, String cusBend, String flag, String cusGradeCode) {
