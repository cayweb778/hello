...
//
	...
	@ApiModelProperty(value = "是否外币核算（1是，0否）需要默认值", position = 27)
	...
	/********** END *********/
	@ApiModelProperty(value = "项目大类ID", position = 21)
	...
	private String fuzhuhesuan;
	private String superCodeBend;
