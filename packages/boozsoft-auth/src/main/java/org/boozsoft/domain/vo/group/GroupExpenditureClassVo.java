...
@ApiModel(value = "GroupExpenditureClassVo对象", description = "GroupExpenditureClassVo对象")
public class GroupExpenditureClassVo extends GroupExpenditureClass implements INode {
