...
public interface AccCarryOverEntryRepository extends ReactiveCrudRepository<AccCarryOverEntry, String> {
    ...
    Flux<AccCarryOverEntry> findAllByOnlyNumOrderById(String onlyNum);
}
