...
import org.boozsoft.domain.entity.carryovers.AccCarryOverEntryRollback;
import org.springframework.data.r2dbc.repository.Query;
import org.springframework.data.repository.reactive.ReactiveCrudRepository;
import reactor.core.publisher.Flux;
import reactor.core.publisher.Mono;

public interface AccCarryOverEntryRollbackRepository extends ReactiveCrudRepository<AccCarryOverEntryRollback, String> {
    ...
    @Query("SELECT DISTINCT\n" +
            ...
            "ORDER BY\n" +
            "\tino_id ASC")
    Flux<AccCarryOverEntry> findAllAccvoucher();
}
