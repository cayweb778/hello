...
export const menus = [
  ...
  */
  ...
  createPlatformMenu({ id: useId(380), path: '/pz-dhZd', component: '', parentId: useId(281), name: '业务单据制单' }),
  ...
  createPlatformMenu({ id: useId(193), path: '/pz-list', component: '', parentId: useId(284), name: '凭证列表' }),
