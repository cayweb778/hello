...
const url = ref("http://81.70.47.206:81/nc");
...
<template>
  <section id="newsletter" class="NewsLetter">
    <div class="container">
      <h2 class="title"><span class="link">开箱即用</span> , 用最简单的方式体验<span class="link">NC</span></h2>
      <div class="form">
      ...
      <p class="help">
        您可以输入一个允许跨域访问的<span class="link">https</span>协议网站来在线体验<span class="link">NC</span>
      </p>
    </div>
  </section>
</template>
