...
enum Api {
  ...
  findAllVoucherSummary = '/accvoucher/findAllVoucherSummary',
...
export const findAllVoucherSummary = defRouteApi(async (params: any) => {
  return {
    url: Api.findAllVoucherSummary,
    method: 'POST',
    params
  }
})
...
export const accvoucherSaves = defRouteApi(async (params: any) => {
  return {
    url: Api.accvoucherSavesApi,
    timeout: 5000000000,
    method: 'POST',
    params
  }
