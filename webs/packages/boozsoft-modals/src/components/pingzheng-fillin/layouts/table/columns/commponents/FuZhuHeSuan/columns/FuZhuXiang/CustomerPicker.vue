<template>
  <div ref="thisSelectRef" class="thisSelectRef" style="height: 40px">
    <ItemListPicker
      ...
      @change="selectBlur"
    />
    <CustomerSelect @throwData="modalData" @register="registerModalPopPage" />
...
import {ref, computed, watch, onMounted, inject} from 'vue';
  ...
  import CustomerSelect from '/@/views/boozsoft/system/customer_info/popup/modalPop.vue';
...
const datasourcePicker=inject('datasourcePicker')
  ...
  function modalData(e) {
    showText.value = e.custName;
    selectBlur(e.custName);
  }
