  ...
  <div>
    ...
    <div class="app-container">
      ...
      <PageWrapper dense content-full-height fixed-height content-class="flex">
        ...
        <div style="width: calc(100% - 750px); float: right;margin-left: 5px;">
...
import {deleteDept, saveDept, editFlag, getDeptListById, GetDeptTree,excelVoucherType} from '/@/api/record/group/fa-ac'
