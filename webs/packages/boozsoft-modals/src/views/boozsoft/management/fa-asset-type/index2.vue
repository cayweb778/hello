  ...
  <div>
    ...
    <div class="app-container">
      ...
      <PageWrapper dense content-full-height fixed-height content-class="flex">
        ...
        <div style=" calc(100% - 250px); float: right;margin-left: 5px;">
...
import {deleteDept, saveDept, editFlag, getDeptListById, GetDeptTree} from '/@/api/record/group/fa-asset-type'
...
const exportExcelNow = async () => {
  ...
  // debugger
  const arrHeader = ['资产类别编码','资产类别名称','上级名称','状态'];
