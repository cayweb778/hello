    ...
    >
      <template #title>
        ...
        <span style="font-size: 24px;line-height:30px;">
          <ShareAltOutlined style="font-size: 28px;font-weight: bold"/>&nbsp;&nbsp;集团授权分配 － 项目分类
        </span>
        </div>
      </template>
...
import {findClassByBend} from "/@/api/record/system/group_project_class";
...
const [register, {closeModal,setModalProps}] = useModalInner(async(data) => {
  ...
  const res:any = await findClassByBend()
