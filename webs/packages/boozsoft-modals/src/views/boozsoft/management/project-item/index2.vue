...
<!--        <img :src="getThisIndexImg()" class="container-head-img" draggable="false">-->
        <div class="container-head-title" style="margin-left: 20px;">
          <b class="noneSpan"><UnorderedListOutlined style="font-size: 26px;" />&nbsp;&nbsp;集团-项目大类</b>
        </div>
...
} from "/@/api/record/system/group-project-item";
...
import {findByUniqueCode} from "/@/api/record/system/group-project-item-account";
...
async function reloadCurrentPage() {
  const res: any = await findAllProjectItemList()
