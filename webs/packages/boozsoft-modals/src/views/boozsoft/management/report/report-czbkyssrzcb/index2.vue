...
import { findByReportName, findByReportNameAndFlag, deleteTemplate, saveTemplate, editFlag } from '/@/api/record/system/group-report-template'
...
async function reloadCurrentPage() {
  const res = await findByReportNameAndFlag("czbkyssrzcb")
