  ...
  >
    <template #title>
      <div style="display: flex;" class="vben-basic-title">
        <span style="line-height:40px;font-size: 28px;">
          ...
          <FormOutlined v-if="isEdit" style="font-size: 34px;font-weight: bold"/> &nbsp;&nbsp;预算来源
        </span>
      </div>
    ...
    >
      <div class="open-content-up" style="text-align: center;margin-top: 13%;">
        ...
        <a-input v-model:value="formItems.bsName" placeholder="预算来源名称" class="abc" style="width: 55%;" />
...
import {editFlag} from "/@/api/record/system/group-budget-source";
