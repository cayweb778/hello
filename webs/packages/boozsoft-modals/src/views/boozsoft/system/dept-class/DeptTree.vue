<template>
  <div class="bg-white mr-0 overflow-hidden">
    <div style="width: 100%;height: 50px;">
      <label style="font-size: 20px;line-height: 50px;margin-left: 20px;">部门支出经济</label>
...
import {saveDept, GetDeptTreeByFlag, getDeptListById} from '/@/api/record/system/dept-class'
