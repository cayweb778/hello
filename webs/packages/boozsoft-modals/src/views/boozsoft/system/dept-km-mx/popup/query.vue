...
import {
  ...
  findBzAll,
  findCodeKmByPeriod, findCusAll, findAllAuthPeriodListByUserAndCode, findProject, findDeptAll
...
async function handleOk() {
  if(kmList.value.length===0){
    return createConfirmPop('请先设置部门辅助科目')
  }
  if(deptList.value.length===0){
    return createConfirmPop('请先设置部门项目信息')
  }
