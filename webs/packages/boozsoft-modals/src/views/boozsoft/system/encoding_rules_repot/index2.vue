  ...
  <div>
    <div class="app-container">
      <div class="app-container-head">
        ...
        <div class="container-head-title" style="padding-left: 35%;text-align: center;margin-top: 30px;">
          <b class="noneSpan" style="font-size: 36px;">单据编码规则</b>
        </div>
    ...
    <div class="app-container" >
      <PageWrapper dense content-full-height fixed-height content-class="flex" >
          <TypeTree  @select="handleSelect" v-model="pageParameter" style="height: 77%;"/>
...
<!--                <a-checkbox :disabled="!isEdit" v-model:checked="pageParameter.fileEncodingRules.autoNum" >自动补空号</a-checkbox>-->
          ...
          <div class="acco-sideline" style="width: 90%;">
            ...
            <div class="acco-sideline-content-one">
              ...
              <div style="width: 20%;padding-left: 0px">
...
import {add, fileInit, load} from '/@/api/record/encoding_rules_report/FileEncodingRules'
...
function selectOne(data) {
  ...
  if(data === '88'){
    ...
    oneDisabled.value =  true
    pageParameter.fileEncodingRules.prefixOneLength  = getQz(fileType.value).qz.find(v=> v.key === data).lenght
    pageParameter.fileEncodingRules.prefixOneCustomize = getQz(fileType.value).qz.find(v=> v.key === data).code
  }
  changeData('one')
}
function selectTwo(data) {
  if(data === '88'){
    ...
    twoDisabled.value =  true
    pageParameter.fileEncodingRules.prefixTwoLength  = getQz(fileType.value).qz.find(v=> v.key === data).lenght
    pageParameter.fileEncodingRules.prefixTwoCustomize = getQz(fileType.value).qz.find(v=> v.key === data).code
  }
  changeData('two')
}
    ...
    if(d){
      if(d.key === '99'){
        ...
        if(d.key === '88'){
          ...
          pOne.value = d.name
          //获取系统预制编码
          s = s+getQz(fileType.value).qz[0].code+sufix
