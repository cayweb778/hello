  ...
  >
    ...
    >
      <div class="open-content-up" style="text-align: center;margin-top: 30px;">
        ...
        <a-input v-model:value="formItems.bsName" placeholder="资产组名称" class="abc" style="width: 55%;" />
...
import {findBySettModes,findByBsName,editFlag} from "/@/api/record/system/fa-asset-group";
