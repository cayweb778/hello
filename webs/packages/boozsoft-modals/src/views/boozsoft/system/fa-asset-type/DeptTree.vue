<template>
  <div class="bg-white mr-0 overflow-hidden">
    <div style="width: 100%;height: 50px;">
      <label style="font-size: 20px;line-height: 50px;margin-left: 20px;">资产类别</label>
...
import {saveDept, GetDeptTreeByFlag, getDeptListById} from '/@/api/record/system/fa-asset-type'
