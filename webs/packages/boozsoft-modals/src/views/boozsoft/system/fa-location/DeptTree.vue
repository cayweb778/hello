<template>
  <div class="bg-white mr-0 overflow-hidden">
    <div style="width: 100%;height: 50px;">
      <label style="font-size: 20px;line-height: 50px;margin-left: 20px;">存放位置</label>
...
import {saveDept, GetDeptTreeByFlag, getDeptListById} from '/@/api/record/system/fa-location'
...
watch(companyName, async () => {
    ...
    if (Object.keys(a).length > 0) {
      ...
      await fetch(dynamicCompany.value)
    }
  }
)
defineExpose({fetch})
