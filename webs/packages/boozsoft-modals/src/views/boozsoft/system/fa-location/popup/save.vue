  ...
  >
    <template #title>
      <div style="display: flex;" class="vben-basic-title">
        <span style="line-height:40px;font-size: 28px;">
          <PlusCircleOutlined style="font-size: 34px;font-weight: bold"/>&nbsp;&nbsp;存放位置
        </span>
      </div>
    ...
    >
      <div class="open-content-up" style="text-align: center;margin-top: 30px;">
        ...
        <label style="font-size: 18px;margin-left: 0;">位置名称：</label>
...
import {getDeptList, GetDeptTreeByFlag,getMaxCode} from '/@/api/record/system/fa-location'
