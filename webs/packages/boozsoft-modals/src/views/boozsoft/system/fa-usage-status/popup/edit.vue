  ...
  >
    <template #title>
      <div style="display: flex;" class="vben-basic-title">
        <span style="line-height:40px;font-size: 28px;">
          <FormOutlined style="font-size: 34px;font-weight: bold"/>&nbsp;&nbsp;使用状况
        </span>
      </div>
    ...
    >
      <div class="open-content-up" style="text-align: center;margin-top: 30px;margin-bottom: 30px;">
        ...
        <label style="font-size: 18px;margin-left: 0;">状况名称：</label>
...
import {getDeptList, GetDeptTreeByFlag, getMaxCode} from '/@/api/record/system/fa-usage-status'
