    ...
    >
      <div class="open-content-up" style="text-align: center;margin-top: 30px;">
        <div style="text-align: left;padding-left: 10%">
          <a-radio-group v-model:value="formItems.flag" name="radioGroup" :disabled="isEdit">
        ...
        <div style="text-align: left;padding-left: 10%">
          ...
          <a-input v-model:value="formItems.peopertyId" @blur="checkRepet" placeholder="请输入编码"
                   style="font-weight: 900"/>
