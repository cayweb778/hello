<template>
  ...
  >
    ...
    <div class="nc-open-content" style="height: 100%" >
      ...
      <span style="line-height:30px;font-size: 24px;color: #0096c7;font-weight: bold;">&ensp;多栏账</span>
                ...
                <div class="special-border-div">
                  ...
                  <div style="display: inline-block;width: 96%;margin-left: 23px;">
                    ...
                    <div style="width: 50%;float: left;">
                      ...
                      <a-select style="width: 190px;text-align: center;" v-model:value="styleValue" @change="styleChange">
                    ...
                    <div style="width: 50%;float: left;padding-left: 20px;">
                      ...
                      <a-select mode="tags" v-model:value="pzType" style="width: 143px;text-align: center;">
                    ...
                    <div style="width: 50%;">
                      ...
                      &emsp;&nbsp;
                      <a-select style="width: 190px;text-align: center;" v-model:value="bz">
...
async function handleOk() {
  ...
  let map={
    ...
    optAction:'查询',
    optContent:'操作内容【多栏账查询】,账套代码【'+pageParameter.companyCode+'】,账套名称【'+pageParameter.companyName+'】,查询条件【查询日期：'+strDate.value+','+endDate.value+'】,' +
      '科目编码【'+minKm.value+'】,科目类型【'+styleValue.value+'】,凭证类型【'+pzType.value+'】,币种【'+bz.value+'】'
  }
  await saveLog(map)
  /************** 记录操作日志 ****************/
...
async function dynamicAdReload(data) {
  ...
  databaseTrue.value =data.accountMode /*data.accId+'-'+data.year*/
  pageParameter.accId=data.accId
  pageParameter.database=databaseTrue.value
