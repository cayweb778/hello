<template>
  <div class="app-container">
    <div class="app-container-top">
      <div class="app-container-head">
        <div class="container-head-title" style="float: none;text-align: center;display: revert;">
          <b class="noneSpan">{{ pageParameter.projectName }}-项目总账</b>
        </div>
    ...
    <div style="app-container-bottom" >
      <BasicTable
        ref="tableRef"
...
<script setup lang="ts">
  ...
  const CrudApi = {
    list: useRouteApi(findAllProject,{schemaName:database}),
  ...
  function resetDynamicColumnData() {
    // 先从数据查询是否已经设置
    lanMuData.accId = databases.value
  ...
  const goto = async () => {
    ...
    const json = {
      ...
      riqi: '',
      parameteraccuracyJSON: JSON.stringify(await useRouteApi(finByParameterAccuracy,{schemaName:database})('')),
    }
    router.push({
