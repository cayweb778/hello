...
async function maxCode(){
  const buCate = await useRouteApi(findBukongProjectCateCode,{schemaName: dynamicTenantId})({})
  if (buCate!=null && buCate.projectCateCode!=null && buCate.projectCateCode!=''){
    ...
    const cate = await useRouteApi(findMaxProjectCateCode, {schemaName: dynamicTenantId})({})
