...
import {findByCode,findByName,getFromEdit,saveProject,findProjectByCateCode} from "/@/api/record/system/group-project";
...
const [register, { closeModal }] = useModalInner(async ({data}) => {
  ...
  const res:any = await findProjectByCateCode(data.projectCateCode)
