...
<!--        <img :src="getThisIndexImg()" class="container-head-img" draggable="false">-->
    ...
    <div style="height:700px;overflow: auto !important;">
      <div class="app-container" style="padding:10px;height:1000px;overflow: auto !important;" v-for="item in itemConfig">
...
async function printDefaultPDF() {
  let pdfName = '现金流量表_'+ year.value + '年_'+pageParameter.companyName+ '.pdf'
