...
import {findAllSysUnitOfMeaType} from "/@/api/record/system/unit-mea";
import {excelVoucherType} from "/@/api/record/system/fa-zj";
...
async function getTypes() {
  ...
  //await useRouteApi(findAllSysUnitOfMeaType, {schemaName: dynamicTenantId})()
