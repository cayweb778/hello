...
<script setup lang="ts">
  ...
  import {
    findAllAccvoucherHexiaoGeren, autoWriteOff, saveManualWriteOff
  ...
  const CrudApi = reactive({
    list: useRouteApi(findAllAccvoucherHexiaoGeren,{schemaName:manipulateDbName.value}),
