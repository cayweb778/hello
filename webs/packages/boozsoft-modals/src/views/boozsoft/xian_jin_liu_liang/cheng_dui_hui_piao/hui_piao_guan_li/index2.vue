...
<!--        <div class="container-head-title" style="margin-left: 20px;">
          <b class="noneSpan"><UnorderedListOutlined />&nbsp;&nbsp;承兑汇票</b>
        </div>-->
        ...
        <div class="container-head-title" style="padding-left: 40%;text-align: center;margin-top: 30px;">
          <b class="noneSpan" style="font-size: 26px;">承兑汇票</b>
        </div>
        ...
        <div class="ant-btn-group" data-v-a1ccd506="" style="float: right">
          ...
          <a-popover placement="bottom">
            ...
            <template #content>
              <span class="group-btn-span-special2 p_specifics" @click="tiexianFlag">贴现锁定</span><br/>
              <span class="group-btn-span-special2 p_specifics" @click="tiexianUnFlag">贴现解锁</span><br/>
              <span class="group-btn-span-special2 p_specifics">贴现</span>
            </template>
          </a-popover>
          <a-popover placement="bottom">
            <a-button class="ant-btn ant-btn-me"><span>背书</span></a-button>
            <template #content>
              <span class="group-btn-span-special2 p_specifics" @click="beishuFlag">背书锁定</span><br/>
              <span class="group-btn-span-special2 p_specifics" @click="beishuUnFlag">背书解锁</span><br/>
              <span class="group-btn-span-special2 p_specifics">背书</span>
            </template>
          </a-popover>
...
const [registerTable, {
  ...
  // api: useRouteApi(findAcceptBillAll, {schemaName: dynamicTenantId}),
  columns: columns,
  bordered: true,
...
async function reloadTable(){
  ...
  let len = 0
  const res:any = await useRouteApi(findAcceptBillAll, {schemaName: dynamicTenantId})({})
...
async function reloadCurrentPage() {
  const res = await useRouteApi(findAcceptBillAll, {schemaName: dynamicTenantId})({})
...
const dynamicAdReload = async (obj) => {
  ...
  /*let res: any = await useRouteApi(findAcceptBillAll, {schemaName: obj.accountMode})(data)
