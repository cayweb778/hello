<template>
  <div class="app-container">
    ...
    <div class="app-container-head">
      ...
      <span style="    margin-left: 10px;"><b>账户信息</b></span>
                  ...
                  >
                    <div style="width: 100%;float: right;" @click="openEdit(item)" >
                      ...
                      <div style="font-size: 24px;">
                        账户名称：{{ item.corpBankName }}
                      </div>
                      <div style="font-size: 16px;">
                        账户编码：{{ item.corpBankCode }}
                      </div>
                    </div>
                  </a-card>
                </a-list-item>
...
import { findCorpBankAll, deleteCorpBank, saveCorpBank } from '/@/api/corp-bank/corp-bank'
...
async function reloadCurrentPage() {
  const res = await findCorpBankAll()
