            ...
            <ul>
              <li>
                ...
                <span>&emsp;&emsp;&emsp;&emsp;公司简称：<span
                  style="color: blue">&emsp;&emsp;&emsp;&emsp;{{showThisCodeToName(modelList['1'].constant.companyCode) }}</span></span>
              </li>
              <li>
          ...
          <a-tab-pane key="3" tab="个人标准模式">
            <ul>
              <li>
                ...
                <span style="color: red;font-size: 18px;">⋆</span>
                <span>&emsp;&emsp;&emsp;&emsp;公司简称：<span
                  style="color: blue">&emsp;&emsp;&emsp;&emsp;{{showThisCodeToName(modelList['3'].constant.companyCode) }}</span></span>
              </li>
              <li>
                <a-radio-group style="width: 100%" v-model:value="radiovalue" @change="radiochange">
                  <p>
