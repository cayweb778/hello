<template>
  <div class="app-container">
    ...
    <div class="app-container-bottom" :style="{height: (windowHeight-200)+'px'}">
      <BasicTable
        ref="tableRef"
      ...
      <div style="text-align: left;padding-bottom: 2px;padding-top: 10px;">
        ...
        <span v-if="editableData2[record.num]">
          ...
          <!--          <a-popconfirm title="是否取消?" @confirm="cancelTable(record.num)" >-->
          <!--            <a style="padding-left:5px;">取消</a>-->
          <!--          </a-popconfirm>-->
        </span>
              <span v-else>
...
const [registerTable, { reload,setColumns,getColumns,setTableData,getDataSource }] = useTable({
  ...
  pagination:{ pageSize: 10,showSizeChanger: true, pageSizeOptions: ['9','18','36','81'],showTotal: t => `总共${t}条数据`, },
  /*actionColumn: {
    width: 100,
    title: '操作',
    dataIndex: 'action',
