...
<!--   <div><textarea>付款统计表的页面</textarea>复制内容快速定位页面</div>-->
    <div class="app-container-top">
      ...
      <div class="app-container-head">
        ...
        <div class="container-head-title" style="padding-left: 35%;text-align: center;margin-top: 20px;">
          <b class="noneSpan" style="font-size: 26px;">付款统计表</b>
...
async function reloadTable(){
  ...
  const res = await useRouteApi(findFkdtjbList,{schemaName: dynamicTenantId})({bcheck:bcheck.value,ddate1:ddate1.value,ddate2:ddate2.value})
  const res1 = await useRouteApi(findFkdYueList,{schemaName: dynamicTenantId})({iyear:pageParameter.year,bcheck:bcheck.value})
  let list:any = []
...
const excelData = () => {
  ...
  const bookType = 'xlsx'
  // 类型默认为xlsx
  writeExcel(wb, bookType, '付款统计表_'+pageParameter.companyName)
}
...
import {findFkdYueList} from "/@/api/record/system/arBeginBalance";
/*start栏目设置*/
