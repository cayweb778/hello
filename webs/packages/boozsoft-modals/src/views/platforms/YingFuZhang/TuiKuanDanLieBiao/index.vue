...
<!--   <div><textarea>退款单列表的页面</textarea>复制内容快速定位页面</div>-->
    <div class="app-container">
      ...
      <div class="app-container-head">
        ...
        <div class="container-head-title" style="padding-left: 35%;text-align: center;margin-top: 20px;">
          <b class="noneSpan" style="font-size: 26px;">退款单列表</b>
        ...
        <div class="ant-btn-group" style="float: right">
          ...
          <Popover placement="bottom">
            ...
            <template #content>
              <span class="group-btn-span-special2 p_specifics">审核</span><br/>
              <span class="group-btn-span-special2 p_specifics">弃审</span>
            </template>
          </Popover>
          <Popover placement="bottom">
...
//import {sub, toThousandFilter} from "/@/views/boozsoft/gdzc/gu-ding-zi-chan-add/calculation";
const sub=null
...
async function reloadTable(){
  loadMark.value = true
  const res = await useRouteApi(findByTypeList,{schemaName: dynamicTenantId})({type:'SKD',year:pageParameter.year})
...
import {findByTypeList, findQuxiaohexiaoList, findYskhxmxb} from "/@/api/record/system/arApYsyf";
