    ...
    <div class="app-container">
      ...
      <div class="app-container-head">
        ...
        <div class="container-head-title" style="padding-left: 35%;text-align: center;margin-top: 20px;">
          <b class="noneSpan" style="font-size: 26px;">撤销应收款核销</b>
...
async function reloadTable(){
  ...
  let len = 0
  const yueList = await useRouteApi(findQuxiaohexiaoYueList,{schemaName: dynamicTenantId})(pageParameter.year)
  const xhdList = await useRouteApi(findQuxiaohexiaoList,{schemaName: dynamicTenantId})(pageParameter.year)
  tableDataAll.value = []
...
import {
  ...
  deleteXyCsouceById,
  findArApWriteOffByCcodeAndHxCcode, findArApYsyfByCcode, findArApYsyfsByCcode,
  findQuxiaohexiaoList, findQuxiaohexiaoYueList,
  findSaleousingByCcode, findXyCsourceByCcodeAndXyccode,
  findYskhxmxb, saveSaleousing, saveYsyf
