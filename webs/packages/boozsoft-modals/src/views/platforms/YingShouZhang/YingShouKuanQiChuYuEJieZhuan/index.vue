...
<!--   <div><textarea>应收款制单的页面</textarea>复制内容快速定位页面</div>-->
    <div class="nc-hr-top">
      ...
      <div style="line-height: 75px;">
        <span style="font-size: 32px;">应收款期初余额结转上年</span>
      </div>
...
<!--          <BasicTable
          ...
          <div class="acco-sideline">
            ...
            <div class="acco-sideline-content-there">
              <Row>
                <Col :span="12">
                  <Checkbox v-model:checked="YSD">
                    上年未核销完成的应收单结转
                  </Checkbox>
                </Col>
                <Col :span="12">
                  <Checkbox v-model:checked="SKD">
                    上年未核销完成的收款单结转
                  </Checkbox>
                </Col>
                <br/><br/>
...
<!--          包含未审核应收单、包含未审核收款单-->
<!--          未完成凭证制单的应收单、包含未完成凭证制单的收款单、包含未完成凭证制单的销货单（销售发票）-->
          <div class="acco-sideline">
            <span>凭证制单</span>
            <div class="acco-sideline-content-there">
              <Row>
