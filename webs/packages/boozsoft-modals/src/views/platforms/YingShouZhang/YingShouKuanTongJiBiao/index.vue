...
<!--   <div><textarea>应收款统计表的页面</textarea>复制内容快速定位页面</div>-->
    <div class="app-container-top">
      ...
      <div class="app-container-head">
        ...
        <div class="container-head-title" style="padding-left: 35%;text-align: center;margin-top: 20px;">
          <b class="noneSpan" style="font-size: 26px;">应收款统计表</b>
...
async function reloadTable(){
  ...
  qijian.value = ddate1.value.replace(/-/g, '.') + " - " + ddate2.value.replace(/-/g, '.')
  const res:any = await useRouteApi(findYsdtjbList,{schemaName: dynamicTenantId})({bcheck:bcheck.value,ddate1:ddate1.value,ddate2:ddate2.value,arSourceFlag:arSourceFlag.value})
  const res1:any = await useRouteApi(findSkdtjbList,{schemaName: dynamicTenantId})({bcheck:bcheck.value,ddate1:ddate1.value,ddate2:ddate2.value})
...
const excelData = () => {
  ...
  const bookType = 'xlsx'
  // 类型默认为xlsx
  writeExcel(wb, bookType, '应收款统计表_'+pageParameter.companyName)
}
