...
<!--   <div><textarea>应收账龄分析的页面</textarea>复制内容快速定位页面</div>-->
    <div class="app-container-top">
      ...
      <div class="app-container-head">
        ...
        <div class="container-head-title" style="padding-left: 35%;text-align: center;margin-top: 20px;">
          <b class="noneSpan" style="font-size: 26px;">应收账龄分析</b>
...
<!--              <TableSummaryCell :index="0" :align="'center'" style="background-color: #cccccc;font-weight: bold;"></TableSummaryCell>
              ...
              <TableSummaryCell class="nc-summary" :index="4" :align="'right'" style="background-color: #cccccc;font-weight: bold;">{{toThousandFilter(hxIsum)}}</TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="5" :align="'right'" style="background-color: #cccccc;font-weight: bold;">{{toThousandFilter(whxIsum)}}</TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="6" :align="'right'" style="background-color: #cccccc;font-weight: bold;">{{toThousandFilter(money1)}}</TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="7" :align="'right'" style="background-color: #cccccc;font-weight: bold;"></TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="8" :align="'right'" style="background-color: #cccccc;font-weight: bold;">{{toThousandFilter(money2)}}</TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="9" :align="'right'" style="background-color: #cccccc;font-weight: bold;"></TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="10" :align="'right'" style="background-color: #cccccc;font-weight: bold;">{{toThousandFilter(money3)}}</TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="11" :align="'right'" style="background-color: #cccccc;font-weight: bold;"></TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="12" :align="'right'" style="background-color: #cccccc;font-weight: bold;">{{toThousandFilter(money4)}}</TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="13" :align="'right'" style="background-color: #cccccc;font-weight: bold;"></TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="14" :align="'right'" style="background-color: #cccccc;font-weight: bold;">{{toThousandFilter(money5)}}</TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="15" :align="'right'" style="background-color: #cccccc;font-weight: bold;"></TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="16" :align="'right'" style="background-color: #cccccc;font-weight: bold;">{{toThousandFilter(money6)}}</TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="17" :align="'right'" style="background-color: #cccccc;font-weight: bold;"></TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="18" :align="'right'" style="background-color: #cccccc;font-weight: bold;">{{toThousandFilter(money7)}}</TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="19" :align="'right'" style="background-color: #cccccc;font-weight: bold;"></TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="20" :align="'right'" style="background-color: #cccccc;font-weight: bold;">{{toThousandFilter(money8)}}</TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="21" :align="'right'" style="background-color: #cccccc;font-weight: bold;"></TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="22" :align="'right'" style="background-color: #cccccc;font-weight: bold;">{{toThousandFilter(money9)}}</TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="23" :align="'right'" style="background-color: #cccccc;font-weight: bold;"></TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="24" :align="'right'" style="background-color: #cccccc;font-weight: bold;">{{toThousandFilter(money10)}}</TableSummaryCell>
              <TableSummaryCell class="nc-summary" :index="25" :align="'right'" style="background-color: #cccccc;font-weight: bold;"></TableSummaryCell>
            </TableSummaryRow>
          </TableSummary>
        </template>
      </BasicTable>
...
async function reloadTable(){
  ...
  const res = await useRouteApi(findYsdByEndDateList,{schemaName: dynamicTenantId})({bcheck:bcheck.value,iyear:pageParameter.year,endDate:endDate.value,arSourceFlag:arSourceFlag.value})
  const res1 = await useRouteApi(findSkdByEndDateList,{schemaName: dynamicTenantId})({bcheck:bcheck.value,iyear:pageParameter.year,endDate:endDate.value})
  ...
  if (agingRang.value.length>=1){
    ...
    const list = await useRouteApi(findYsdByDateList, {schemaName: dynamicTenantId})({
      bcheck:bcheck.value,
    ...
    if(agingRang.value.length==1){
      ...
      const list1 = await useRouteApi(findYsdByEndDateList,{schemaName: dynamicTenantId})({bcheck:bcheck.value,iyear:pageParameter.year,endDate:ddate,arSourceFlag:arSourceFlag.value})
      tableDataAll.value.forEach(item=>{
        list1.forEach(item1=>{
          if (item.cvencodeJs==item1.cvencodeJs) {
...
function openYsmx(data){
  // console.log(data)
  router.push({
    path: '/YingShouZhang/ZhangBiao/ZhangBiaoMingXi/YingShouMingXiBiao',
    query: {
  ...
  useNewPrint({data: ['l', 'px', 'a4', true]}, (doc) => {
    ...
    doc.autoTable({
      head: [['应收账龄分析','', '', '',  '', '', '', '', ''],
        ...
        ['销售客户编码', '销售客户名称','结算客户编码', '结算客户名称', '应收金额', '已收金额', '未收金额', '开票金额', '收款比例']
      ],
      body: printList,
      // startY: 60,
      styles: tableStyle(),
...
const excelData = () => {
  ...
  const bookType = 'xlsx'
  // 类型默认为xlsx
  writeExcel(wb, bookType, '应收账龄分析_'+pageParameter.companyName)
}
...
import {findYsdByDateList, findYsdByEndDateList, findYsdtjbList} from "/@/api/record/system/ysd";
import {findSkdByEndDateList, findSkdtjbList} from "/@/api/record/system/arApYsyf";
