    ...
    <div class="app-container lcr-theme-div">
      <div>
        ...
        <div>
          ...
          <div>
             <span style="color: black;margin-left: 1em;">客户名称：</span>
            <Select  style="width: 250px" v-model:value="pageParameter.selectClass" @change="selectChange">
...
async function saveQuery(e) {
  ...
  if (pageParameter.queryMark != data.constant.queryType)resetDynamicColumnData()
...
const reloadColumns = () => {
  let a: any = []
  a = getColumns()
  let newA = JSON.parse(JSON.stringify(getTablePropertys('1')))
