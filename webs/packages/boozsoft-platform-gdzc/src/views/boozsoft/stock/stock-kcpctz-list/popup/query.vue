    ...
    <div style="display: inline-flex;justify-content: space-between;width: 100%;">
      <div style="width: calc(100% - 150px);height: 100%;">
        <div style="display: flex;margin-top: 10px">
          ...
          <span style="line-height:30px;font-size: 24px;color: #0096c7;font-weight: bold;">&ensp;库存批次台账查询</span>
        </div>
            ...
            <div class="border-div">
              ...
              <div style="margin-left: 72px;">
                <ul>
                  ...
                  <li style="margin: 2% 0px;">
                    <span style="text-align: left"> <font style="color: red">*</font>存货批号：</span>
                    <a-input v-model:value="formItems.pcNum" placeholder="请输入存货批号"  style="width: 60%;margin-left: 28px;" />
                  </li>
                  <li style="margin: 2% 0px;">
                    ...
                    <a-select
                      ...
                      style="width: 60%;text-align: center;margin-left: 28px;"
                    >
...
async function handleOk() {
  ...
  if(!formItems.value.pcNum){
    message.error("请输入存货批次")
    return
  }
