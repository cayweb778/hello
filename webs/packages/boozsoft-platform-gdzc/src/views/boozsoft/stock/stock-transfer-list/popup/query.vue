    ...
    <div style="display: inline-flex;justify-content: space-between;width: 100%;">
      <div style="width: calc(100% - 150px);height: 100%;">
        <div style="text-align: center;padding: 10px 0 5px;">
          ...
          <span style="line-height:30px;font-size: 24px;color: #0096c7;font-weight: bold;">&ensp;调拨单列表</span>
        </div>
          ...
          <div class="open-content-up">
            ...
            <div class="border-div">
              ...
              <div style="padding-left: 15px;">
                ...
                <a style="font-weight: bold;font-size: 18px;"><LinkOutlined @click="openHeadSelectContent('cangck')" /></a>
              </div>
              <div style="padding-left: 15px;">
                <label>调出仓库：</label>
                <a-select
