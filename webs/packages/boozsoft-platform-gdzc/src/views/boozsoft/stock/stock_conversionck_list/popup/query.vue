    ...
    <div style="display: inline-flex;justify-content: space-between;width: 100%;">
      <div style="width: calc(100% - 150px);height: 100%;">
        <div style="text-align: center;padding: 10px 0 5px;">
          ...
          <span style="line-height:30px;font-size: 24px;color: #0096c7;font-weight: bold;">&ensp;形态转换出入库单列表</span>
        </div>
            ...
            <div class="border-div">
              ...
              <div style="text-align: center">
                ...
                <a-select
                  ...
                  show-search
                  style="width: 60%;text-align: center;margin-left: 15px;font-weight: bold;"
                >
                  <a-select-option
              ...
              <div style="text-align: center">
                <label>单据编码：</label>
                <a-input :allowClear="true" v-model:value="ccode" placeholder="" style="width: 60%;margin-left: 20px;"/>
              </div>
...
//************************************* 查询条件 ***************************
const dataType: any = ref('XTZHRKD')
const dataTypeList: any = ref([{title:'形态转换入库',value:'XTZHRKD'},{title:'形态转换出库',value:'XTZHCKD'}])
const sup: any = ref('')
