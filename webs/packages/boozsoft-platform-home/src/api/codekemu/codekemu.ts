...
export const company_findByCodeNum = defRouteApi(
  async (params) => {
    return {
      url:
        Api.company_findByCodeNum,params,
      method: 'POST',timeout: 100000000000,
    };
  }
);
...
export const company_findByCodeName = defRouteApi(
  async (params) => {
    return {
      url:
        Api.company_findByCodeName,params,
      method: 'POST',timeout: 100000000000,
    };
  }
);
export const company_findBySuperCodeName = defRouteApi(
  async (params) => {
    return {
      url:'/sys/acckemu/company/company_findBySuperCodeName',params,
      method: 'POST',timeout: 100000000000,
    };
  }
);
...
export const companyfindAll = defRouteApi((params) => {
  return {
    url: '/sys/acckemu/company/companyfindAll',
    timeout: 100000000000,
    method: 'POST',
    params
  };
...
export const findByLastCodeHierarchyNames = defRouteApi(async (params) => {
  return {
    url: '/sys/acckemu/company/findByLastCodeHierarchyNames',
    method: 'POST',
    timeout: 100000000000,
    params
  };
