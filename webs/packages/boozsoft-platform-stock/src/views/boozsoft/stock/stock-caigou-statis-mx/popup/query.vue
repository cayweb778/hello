<template>
  ...
  >
    ...
    <div class="nc-open-content" style="height: 100%">
      ...
      <span style="line-height:30px;font-size: 24px;color: #0096c7;font-weight: bold;">&ensp;采购明细表</span>
        ...
        <ul style="width: 80%;display: inline-block;margin-top: -29px;margin-left: 10%;">
          <li>
            <div class="special-border-div">
              ...
              <AccountPicker style="padding-left: 80px;" theme="three" @reloadTable="codeChange"/>
            </div>
          </li>
          <li>
            <div class="special-border-div">
...
async function reLifeEtcList(dynamicTenant) {
  let q = ['user', 'supplier', 'dept', 'operator', 'warehouse', 'stock', 'whClass','custClass','zone']
...
async function handleOk() {
  ...
  //   return message.error('请选择存货！');
  // }
  // if(defaultTabsKey.value=='2' && hasBlank(queryModel.variable.cvencode)){
  ...
  queryModel.variable.type='CGDHD'
