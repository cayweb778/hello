<template>
  ...
  >
    ...
    <div class="nc-open-content">
      ...
      <span style="line-height:30px;font-size: 24px;color: #0096c7;font-weight: bold;">&ensp;采购统计表</span>
      <div class="open-content-up">
        ...
        <Tabs type="card" v-model:activeKey="defaultTabsKey" tabPosition="left" style="width: 20%;float: left;">
          <TabPane key="1" tab="存货采购统计表"></TabPane>
          <TabPane key="2" tab="供应商采购统计表"></TabPane>
        </Tabs>
        <ul style="width: 80%;display: inline-block;margin-top: -29px;">
          <li>
            <div class="special-border-div">
              <span style="color: #5a5a5a">业务范围</span>
              <AccountPicker theme="three" @reloadTable="codeChange" style="margin-left: 60px;text-align: left;"/>
            </div>
          </li>
          <li>
            <div class="special-border-div">
