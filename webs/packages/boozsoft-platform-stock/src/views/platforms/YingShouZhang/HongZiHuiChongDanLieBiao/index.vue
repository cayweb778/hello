...
async function reloadTable(){
  ...
  let len = 0
  const res = await useRouteApi(findArApHzhcdList,{schemaName: dynamicTenantId})({billStyle:'SKD',iyear:pageParameter.year})
...
function addPage(){
  ...
  router.push({
    path: '/YingShouZhang/ChongXiao/CaoZuo/CxHongZiHuiChong',
    query: pageParameter
  });
}
...
import {findArApYsyfByCcode, saveSaleousing, saveYsyf} from "/@/api/record/system/arApYsyf";
import {
