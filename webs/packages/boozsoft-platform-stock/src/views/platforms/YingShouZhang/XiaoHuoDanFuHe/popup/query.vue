    ...
    <div style="display: inline-flex;justify-content: space-between;width: 100%;">
      <div style="width: calc(100% - 150px);height: 100%;">
        <div style="text-align: center;padding: 10px 0 5px;">
          ...
          <span style="line-height:30px;font-size: 24px;color: #0096c7;font-weight: bold;">&ensp;销货单复核</span>
        </div>
          ...
          <div class="open-content-up">
            ...
            <div class="border-div">
              ...
              <div>
                ...
                <a-input v-model:value="strNum" placeholder="" :allowClear="true" style="width: 100px;margin-left: 20px;"/>
                <span>~</span>
                <a-input v-model:value="endNum" placeholder="" :allowClear="true" style="width: 100px"/>
              ...
              <div>
                <label style="width: 110px;">客户：&emsp;</label>
                &nbsp;
                <a-select
                  v-model:value="sup"
                  show-search
              ...
              <div>
                ...
                <label style="margin-left: 25px;width: 110px;">业务人：&emsp;</label>
                &nbsp;
                <a-select
...
import { findAll as findSupAll} from "/@/api/record/costomer_data/customer";
...
const dataTypeList: any = ref([{title:'全部',value:''},{title:'已复核',value:'1'},{title:'未复核',value:'0'}])
const sup: any = ref('')
...
function handleOk() {
  if (formItems.value.arCheckFlag!='1'){
    createConfirm({
      iconType: 'error',
      title: '警告',
      content: '当前账套应收选项设置，应收单据无需进行财务复核，是否退出?',
      onOk: async () => {
        await handleClose()
        return false
      },
  ...
  let map={
    ...
    arHexiaoAuto: formItems.value.arHexiaoAuto,
    arSourceFlag: formItems.value.arSourceFlag,
    arCheckFlag: formItems.value.arCheckFlag,
