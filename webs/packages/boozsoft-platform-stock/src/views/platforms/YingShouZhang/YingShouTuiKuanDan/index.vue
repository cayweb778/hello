            ...
            <template #summary>
              <TableSummary fixed>
                <TableSummaryRow style="background-color: #cccccc;font-weight: bold;">
                  <TableSummaryCell class="nc-summary" :index="0" :align="'center'">合</TableSummaryCell>
                  <TableSummaryCell class="nc-summary" :index="1" :align="'center'">计</TableSummaryCell>
                  <TableSummaryCell :index="2" :align="'center'"></TableSummaryCell>
                  <TableSummaryCell :index="3" :align="'center'"></TableSummaryCell>
                  <TableSummaryCell :index="4" :align="'center'"></TableSummaryCell>
                  <TableSummaryCell :index="5" :align="'center'"></TableSummaryCell>
                  <TableSummaryCell :index="6" :align="'right'" style="background-color: #cccccc;font-weight: bold;">{{ toThousandFilter(isum1) }}</TableSummaryCell>
                  ...
                  <TableSummaryCell :index="8" :align="'right'" style="background-color: #cccccc;font-weight: bold;">{{ toThousandFilter(hxMoney) }}</TableSummaryCell>
                  <TableSummaryCell :index="9" :align="'right'" style="background-color: #cccccc;font-weight: bold;">{{ toThousandFilter(idiscount) }}</TableSummaryCell>
                  <TableSummaryCell :index="10" :align="'center'"></TableSummaryCell>
                </TableSummaryRow>
              </TableSummary>
            </template>
          </BasicTable>
