<template>
  <div ref="thisSelectRef" className="thisSelectRef" style="height: 40px">
    <ItemListPicker
      ref="inputRef"
      v-model="showText"
      :items="propsList"
...
import ItemListPicker from '../FuZhuXiang/ItemListPicker.vue';
...
function clickRecord() {
  openSelectDeptPage(true, {
    dynamicTenantId: 'bjhzzkgl-001-2021',
  });
}
