<template>
  <BasicModal width="940px" v-bind="$attrs" title="集团"
              ...
              :cancel-text="isLook?'关闭':'取消'" :canFullscreen="false"
              @register="register" :draggable="false">
    <template #title>
      <div style="height: 30px;width: 100%;background-color: #5f375c;color: white;line-height: 30px;">
        <AppstoreOutlined  style="margin: 0 2px;font-size: 14px;"/>
        <span style="font-size: 14px">集团管理</span>
      </div>
    </template>
...
import {findByCode, findByName, importImg, saveGroup} from "/@/api/record/group/im-group";
