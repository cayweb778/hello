  ...
  >
    <template #title>
      <div style="display: flex;" class="vben-basic-title">
        ...
        <span style="line-height: 25px;font-size: 16px;">职务类别</span>
      </div>
    </template>
    <div
    ...
    >
      <div class="open-content-up" style="text-align: center;margin-top: 30px;">
        ...
        <label style="font-size: 18px;margin-left: 0;">类别名称：</label>
...
import {
  ...
  getMaxCode,
  getTypeList
} from '/@/api/record/group/job-file'
...
async function handleOk() {
  let res =await useRouteApi(getTypeList,{schemaName: dynamicTenantId})({})
  console.log(res)
