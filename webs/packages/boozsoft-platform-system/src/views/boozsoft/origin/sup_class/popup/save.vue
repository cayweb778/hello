...
<script setup="props, { content }" lang="ts">
  ...
  const [register, { closeModal }] = useModalInner((data) => {
    let map={
      searchValue: '',
      superid: '',
      orgUnique: data.orgUnique,
    }
    treeCustomerClass(map).then((res) => {
