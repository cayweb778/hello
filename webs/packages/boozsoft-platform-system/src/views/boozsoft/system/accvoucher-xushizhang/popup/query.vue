<template>
  ...
  >
    ...
    <div class="nc-open-content" style="height: 100%" >
      ...
      <span style="line-height:30px;font-size: 24px;color: #0096c7;font-weight: bold;">&ensp;序时账</span>
      <div class="open-content-up">
        <div class="ocup-position">
          <PicLeftOutlined/>
          查询方案
        </div>
        <Assist @modify="assistModify" @register="registerAssist" />
            ...
            <ul style="width: 93%;margin-top: -20px;">
              <li>
                <div class="special-border-div">
                  ...
                  <AccountPicker theme="one" @reloadTable="codeChange" style="display: block;"/>
                </div>
              </li>
              <li>
                <div class="special-border-div">
                ...
                <div class="special-border-div">
                  ...
                  <div style="display: inline-block;width: 96%;margin-left: 23px;">
                    <div style="float: left;">
                      ...
                      <a-input v-model:value="modelList['1'].variable.voucherNumberStart" :allowClear="true" placeholder="" style="width: 210px"/>
                      <span>&emsp;~&emsp;</span>
                      <a-input v-model:value="modelList['1'].variable.voucherNumberEnd" :allowClear="true" placeholder="" style="width: 210px"/>
                    </div>
                    ...
                    <div style="width: 50%;float: left;">
                      <span class="right_span">科目编码：</span>
                      <a-select
                        :allowClear="true"
                        show-search
                    ...
                    <div style="width: 50%;float: left;padding-left: 20px;">
                      <span class="right_span">科目方向：</span>
                      <a-select
                        :allowClear="true"
                        placeholder=""
                        style="width: 145px"
                      ...
                      >
                        ...
                        <a-select-option value="df">贷方</a-select-option><template #suffixIcon><CaretDownOutlined style="color:#666666;" /></template>
                      </a-select>
                    </div>
                    <div style="width: 50%;float: left;">
                      <span class="right_span">外币币种：</span>
                      <a-select show-search style="width: 210px;text-align: center;" v-model:value="modelList['1'].constant.currency" :allowClear="true">
                    ...
                    <div style="width: 50%;float: left;padding-left: 20px;">
                      ...
                      <a-select
                        ...
                        <a-select-option value="5">冲销</a-select-option><template #suffixIcon><CaretDownOutlined style="color:#666666;" /></template>
                      </a-select>
                    </div>
                    <div style="float: left;">
                    ...
                    <div style="float: left;">
                      <span class="right_span">数量：</span>
                      &emsp;&nbsp;
                      <a-input v-model:value="modelList['1'].variable.numberMin" :allowClear="true" placeholder="" style="width: 210px"/>
                      <span>&emsp;~&emsp;</span>
                      <a-input v-model:value="modelList['1'].variable.numberMax" :allowClear="true" placeholder="" style="width: 210px"/>
                    </div>
                    <div style="float: left;">
                      <span class="right_span">外币金额：</span>
                      <a-input v-model:value="modelList['1'].variable.wbAmountMin" :allowClear="true" placeholder="最小金额" style="width: 210px"/>
                      <span>&emsp;~&emsp;</span>
                      <a-input v-model:value="modelList['1'].variable.wbAmountMax" :allowClear="true" placeholder="最大金额" style="width: 210px"/>
                    </div>
                    <div style="width: 50%;float: left;">
                    ...
                    <div style="width: 50%;float: left;padding-left: 20px;">
                      ...
                      >
                        ...
                        <a-select-option value="2">待记账</a-select-option><template #suffixIcon><CaretDownOutlined style="color:#666666;" /></template>
                      </a-select>
                    </div>
                    <div style="width: 50%;float: left;">
                      ...
                      <a-select
                        ...
                        style="width: 210px;text-align: center;"
                      >
                        <a-select-option v-for="(item,index) in userList" :key="index" :value="item.psnName">{{ item.psnName }}
                        </a-select-option><template #suffixIcon><CaretDownOutlined style="color:#666666;" /></template>
                      </a-select>
                    </div>
                    <div style="width: 50%;float: left;padding-left: 20px;">
                      <span class="right_span">审核人：</span>
                      &nbsp;
                      <a-select
                        :allowClear="true"
                        show-search
                    ...
                    <div style="width: 50%;float: left;">
                      <span class="right_span">出纳人：</span>
                      &nbsp;
                      <a-select
                        :allowClear="true"
                        show-search
                    ...
                    <div style="width: 50%;float: left;padding-left: 20px;">
                      <span class="right_span">财务主管：</span>
                      <a-select
                        :allowClear="true"
                        show-search
                    ...
                    <div style="width: 50%;float: left;">
                      <span class="right_span">记账人：</span>
                      &nbsp;
                      <a-select
                        :allowClear="true"
                        show-search
                    ...
                    <div style="width: 50%;float: left;padding-left: 20px;">
                      <span class="right_span">核算：</span>
                      &emsp;
                      <a-input style="width: 58%;" v-model:value="modelList['1'].variable.accounting[hsKey]" class="addonAfter-input" >
                        <template #addonAfter>
...
const reLifeQueryParameter = async (dynamicTenant) => {
  ...
  if (fzL.length > 0) fzL.forEach(item=>filterDatas2.push({key: 'cdfine'+item.cdfine,title: item.cname}))
  //加载期间数据
  dateList.value = []
...
const codeChange = async (value) => {
  ...
  pageParameter.companyCode=value.coCode
  pageParameter.database=value.accountMode/*value.accId+'-'+value.year*/
  pageParameter.accNameAll=value.target.accName
    let newName = value.accId
    // 查看是否存在 查询参数
    dbQueryJson.accountId = newName;
    let dbQueryData =null /*await findParameterValue(dbQueryJson)*/
...
async function handleOk() {
  ...
  modelList[defaultTabsKey.value].pageParameter = pageParameter
  ...
  let map={
    ...
    optAction:'查询',
    optContent:'操作内容【明细账查询】,账套代码【'+pageParameter.companyCode+'】,账套名称【'+pageParameter.accNameAll+'】,查询条件【查询日期：'+strDate.value+','+endDate.value+'】,' +
      '凭证编号【'+modelList['1'].variable.voucherNumberStart+','+modelList['1'].variable.voucherNumberEnd+'】,凭证摘要【'+modelList['1'].variable.summary+'】,凭证类别【'+modelList['1'].variable.voucherType+'】,' +
      '科目编码【'+modelList['1'].variable.subjectNumber+'】,科目方向【'+modelList['1'].variable.direction+'】,外币币种【'+modelList['1'].constant.currency+'】,凭证状态【'+modelList['1'].variable.reviewStatus+'】,' +
      '本币金额【'+modelList['1'].variable.amountMin+','+modelList['1'].variable.amountMax+'】,数量【'+modelList['1'].variable.numberMin+','+modelList['1'].variable.numberMax+'】,' +
      '外币金额【'+modelList['1'].variable.wbAmountMin+','+modelList['1'].variable.wbAmountMax+'】,审核状态【'+modelList['1'].variable.reviewStatus+'】,记账状态【'+modelList['1'].variable.bookStatus+'】,' +
      '制单人【'+modelList['1'].variable.checkMan+'】,审核人【'+modelList['1'].variable.preparedMan+'】,出纳人【'+modelList['1'].variable.cashierMan+'】,财务主管【'+modelList['1'].variable.reviewMan+'】,' +
      '记账人【'+modelList['1'].variable.bookMan+'】,核算【'+modelList['1'].variable.accounting[hsKey]+'】,',
  }
  await saveLog(map)
