  ...
  >
    ...
    >
      <div class="open-content-up">
        <label style="font-size: 14px;">属性：</label>
        <a-select
        ...
        <label style="font-size: 14px;">类别：</label>
        <a-select
        ...
        <span class="red_span"></span>
        <br>
        <label style="font-size: 14px;">省市区：</label>
        ...
        <span class="red_span"></span>
        <br/>
        <label style="font-size: 14px;">国家(地区)：</label>
        <a-select
...
<!--                <a-select-option value="1">居民身份证</a-select-option>
              ...
              <label>入职日期：</label>
              <a-date-picker v-model:value="formItems.entryDate" placeholder="" :locale="localeCn" format="YYYY-MM-DD" value-format="YYYY-MM-DD" style="width: 30%;"/>
              <span class="red_span"></span>
              <label>离职日期：</label>
              <a-date-picker v-model:value="formItems.leaveDate" placeholder="" :locale="localeCn" format="YYYY-MM-DD" value-format="YYYY-MM-DD" style="width: 30%;"/>
              <span class="red_span"></span>
            </div>
          </a-tab-pane>
          <a-tab-pane
