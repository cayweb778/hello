  ...
  >
    <template #title>
      <div style="display: flex;" class="vben-basic-title">
        ...
        <span style="line-height:40px;font-size: 28px;margin-top: 10px;margin-left: 10px;" v-if="isState=='1'">
          <FormOutlined style="font-size: 34px;font-weight: bold"/>&nbsp;&nbsp;人员信息
        </span>
        <span style="line-height:40px;font-size: 28px;margin-top: 10px;margin-left: 10px;" v-if="isState=='2'">
    ...
    <div :class="isEdit?'nc-open-content':'nc-open-show-content'">
      <div class="open-content-up">
        ...
        <a-input v-model:value="formItems.psnCode" :disabled="isManual" :placeholder="isEdit?'请输入编号（不允许重复）':''" style="font-size: 15px;"/>
        <span class="red_span">{{isState=='2'?'':'*'}}</span>
...
import {getPsnList, savePsn} from "/@/api/record/system/psn";
...
import {findBukongPsnCode, findMaxPsnCode} from "/@/api/record/system/psn";
