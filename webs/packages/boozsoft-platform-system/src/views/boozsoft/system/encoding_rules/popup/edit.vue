  ...
  >
    ...
    <div style="height: 100%;" :class="isEdit?'nc-open-content':'nc-open-show-content'">
      <div class="open-content-up">
        ...
        <a-radio-group v-model:value="formItems.psnType">
        ...
        <div :style="isState=='2'?'':{'text-align': 'center'}">
        <label style="font-size: 14px;">人员编码：</label>
        <a-input v-model:value="formItems.psnCode" :placeholder="isEdit?'请输入编号（不允许重复）':''"/>
        <span class="red_span">{{isState=='2'?'':'*'}}</span>
      ...
      <div class="open-content-down" style="margin-bottom: 0;" :style="isState=='2'?'':{'text-align': 'center'}">
        <a-tabs v-model:activeKey="activeKey" type="card">
          <a-tab-pane key="1" tab="入职信息">
