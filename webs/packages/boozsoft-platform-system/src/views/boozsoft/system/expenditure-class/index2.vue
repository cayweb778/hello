  ...
  <div>
    ...
    <div class="app-container">
      ...
      <PageWrapper dense content-full-height fixed-height content-class="flex">
        ...
        <DeptTree v-if="isShowTree"  @select="handleSelect" v-model="pageParameter"/>
        </div>
...
import {deleteDept, saveDept, editFlag, getDeptListById, GetDeptTree,getTotalData} from '/@/api/record/system/expenditure-class'
