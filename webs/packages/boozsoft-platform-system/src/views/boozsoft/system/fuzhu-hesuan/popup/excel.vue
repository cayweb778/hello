...
import {getDefinedFileList} from "/@/api/record/system/defined-file";
...
const [register, {closeModal}] = useModalInner((data) => {
  ...
  useRouteApi(getDefinedFileList, {schemaName: dynamicTenantId})({}).then(res => {
    res.forEach(item => {
      const item1: any = {}
  ...
  useRouteApi(findAllFuzhuHesuanList, {schemaName: dynamicTenantId})({}).then(res => {
