    ...
    <div class="app-container-top">
      <div class="app-container-head">
        ...
        <div>
          ...
          <div style="display: inline-block;font-size: 14px;float: none;text-align: center;display: revert;padding-left: 11%;">
            &emsp;&emsp;<span style="font-size: 14px;">期间：</span><span style="color: black;font-weight: bold">{{ pageParameter.strDate }}~{{ pageParameter.endDate }}</span>
          </div>
        </div>
        ...
        <div style="margin-top: .1%;">
          <div style="display: inline-block;font-size: 14px;width: 50%">
            <div style="display: inline-block;font-size: 14px;padding-top: 8px">
              ...
              &emsp;&emsp;<span style="font-size: 14px;">本位币：</span><span style="font-size: 14px;font-weight: bold">{{ bzName }} </span>
<!--              &emsp;&emsp;<span style="font-size: 14px;">样式：</span><span style="color: black;font-weight: bold">{{ styleName }}</span>-->
            </div>
          </div>
...
const loadPage = async(map)=>{
  ...
  pageParameter.pzType = data.pzType.join(',')
