        ...
        <a-tabs v-model:activeKey="activeKey" tabPosition="left" type="card" @change="tabChange">
          <a-tab-pane key="" tab="标准模式">
            <ul>
              ...
              <li>
                <a-radio-group  style="width: 100%" v-model:value="jc"  @change="handleChangeJc">
              ...
              <li>
                ...
                <a-select style="width: 120px" v-model:value="showStyle">
                  <a-select-option  v-for="d in showStyleList" :value="d.value">
                    {{ d.name }}
                  </a-select-option>
                  <template #suffixIcon><CaretDownOutlined style="color:#666666;" /></template>
                </a-select>

                <span>&emsp;币&emsp;&emsp;种：</span>
