    ...
    <div class="app-container-top">
      <div class="app-container-head">
        <div class="container-head-title" style="float: none;text-align: center;display: revert;">
          <b class="noneSpan">{{ titleName }}-科目部门总账</b>
        </div>
...
<script setup lang="ts">
  ...
  import { useDeptGlStore } from '/@/api/record/generalLedger/kmDeptGeneralLedger'

  import {onMounted, reactive, ref} from "vue";
  import moment from "moment";
  import {useCompanyOperateStoreWidthOut} from "/@/store/modules/operate-company";
  import { initDynamics,assemblyDynamicColumn} from "./data";
  import Query from "/@/views/boozsoft/system/km-dept-generalledger/popup/query.vue";
  ...
  import {findAllKmDept} from "/@/api/record/generalLedger/data";
  ...
  const lanMuData = {'accId':'','menuName':'科目部门总账','type':'',objects: '',username:useUserStoreWidthOut().getUserInfo.username}
  // 表格参数
  ...
  const CrudApi = {
    list: useRouteApi(findAllKmDept,{schemaName:databasesName.value}),
