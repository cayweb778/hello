    ...
    <div class="app-container-top">
      <div class="app-container-head">
        <div class="container-head-title" style="float: none;text-align: center;display: revert;margin-left:0px">
          <b class="noneSpan" >{{ titleName }}多栏账</b>
        </div>
        ...
        <div>
          ...
          <div style="display: inline-block;font-size: 14px;float: none;text-align: center;display: revert;padding-left: 10%;">
        ...
        <div style="margin-top: .1%;">
          <div style="display: inline-block;margin-left: 1%;font-size: 14px;width: 50%">
            <div style="display: inline-block;font-size: 14px;padding-top: 25px">
              <span style="font-size: 14px;">核算科目：</span><span style="font-size: 14px;font-weight: bold">{{ titleName}} </span>
              &emsp;&emsp;<span style="font-size: 14px;">币种：</span><span style="font-size: 14px;font-weight: bold">{{ bzName }} </span>
