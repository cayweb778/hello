  ...
  >
    <div class="nc-open-content" style="min-height: 500px;">
      <div class="open-content-up">
        ...
        <label>栏目名称：</label>
        <a-input v-model:value="formItems.base.columnShowName" placeholder="栏目名称"
                 style="width: 30%"/>
        <label>显示级次：</label>
        ...
        <br/>
        <label>行次：</label>
        <a-input type="number" v-model:value="formItems.base.hangci" @blur="checkHangci()"
                 placeholder="行次" style="width: 30%"/>
        <label>计算方式：</label>
        <a-select v-model:value="formItems.base.formulaMethod" @change="checkMethod()"
                  style="width: 30%">
          <a-select-option value="">请选择</a-select-option>
        ...
        <br/>
        <label>取值方式：</label>
        <a-select v-model:value="formItems.base.valueMethod" :disabled="!showKemu"
                  style="width: 30%">
          <a-select-option value="">请选择</a-select-option>
      ...
      <div style="margin: 5px 30px;">
        <div>
          <a-button @click="createRow()"
                    style="padding: 0px 4px; height: 25px;background-color: rgb(1,129,226);color: #ffffff">
            <PlusOutlined/>
          </a-button>
        </div>

        <table v-show="showHangci" class="layui-table" id="tableId1"
               style="height: calc( 100% - 20px );background-color:#f2f4f6;">
          <thead>
          ...
          <tbody id="tbody1"
                 style="height: calc( 100% - 20px );margin-top: 10px;background-color:#f2f4f6;">
        ...
        <table v-show="showKemu" class="layui-table" id="tableId"
               style="height: calc( 100% - 20px );margin-top: 10px;background-color:#f2f4f6;">
          <thead>
          <tr class="dy_table_thead_tr even">
            <th>科目编码-科目名称</th>
