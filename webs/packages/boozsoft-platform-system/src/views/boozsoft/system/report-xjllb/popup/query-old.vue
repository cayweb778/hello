  ...
  >
    ...
    >
      <div class="open-content-up">
        ...
        <div style="background: #ffffff;position: relative;border: 1px solid #999999;margin: 20px 40px;padding: 10px 20px;border-radius: 5px;">
          <div style="position: absolute;background: #ffffff; top: -15px;left: 20px;padding: 0 10px;">取值范围</div>
          <a-radio-group style="width: 100%" v-model:value="radiovalue">
            <a-radio :value="1"><span>月份：</span></a-radio>
            <a-select v-model:value="formItems.month" :disabled="radiovalue!='1'" style="width: 150px;">
            ...
            <a-select v-model:value="formItems.jidu" :disabled="radiovalue!='2'" style="width: 150px;">
...
async function handleOk() {
  ...
  if (radiovalue.value == '1') {
    ...
    template.iperiod1 = formItems.value.month
    template.iperiod2 = formItems.value.month
    ...
    if (formItems.value.jidu == '1') {
      ...
      template.iperiod1 = '10'
      template.iperiod2 = dateList.value.length
      date = '第四季度'
    }
