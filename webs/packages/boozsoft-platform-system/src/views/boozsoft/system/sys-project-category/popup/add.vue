  ...
  <BasicModal width="900px" v-bind="$attrs" title="项目大类" @ok="handleOk()" @register="register">
    <div class="nc-open-content">
      <div class="open-content-up" style="height: 600px">
        <label>大类编码</label>
        <a-input v-model:value="itemConfig.base.projectCateCode" @input.native="checkCateCode()" @blur="repeatCateCode()" placeholder style="width: 20%" />
        <label>大类名称</label>
...
import { columnFindCate,findByDatabaseUniqueCode,findProCateByCode,findProCateByName } from '/@/api/sys_project_category/project_category'
