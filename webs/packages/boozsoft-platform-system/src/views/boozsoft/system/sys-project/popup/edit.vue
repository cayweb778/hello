    ...
    <div class="nc-open-content" style="height: 100%">
      <div class="open-content-up">
        <a-input @blur="checkName()"
          ...
          placeholder="请输入项目名称"
          style="margin-left: 6%;font-size: 20px;"
        />
        <span>必填项</span>
        <label />
        <a-select
        ...
        <label>项目编码</label>
        <a-input v-model:value="formItems.projectCode" @blur="checkCode()" placeholder="请输入项目编码" style="width: 30%" />
        <span>必填项</span>
        <label>所属部门</label>
        <TreeSelect
        ...
        <label>开始日期</label>
        <a-date-picker v-model:value="formItems.startDate" format="YYYY-MM-DD" style="width: 35%;" />
        <label>结束日期</label>
        <a-date-picker v-model:value="formItems.endDate" format="YYYY-MM-DD" style="width: 35%;" />
        <br />
        ...
        <label>是否结算</label>
        <a-select v-model:value="formItems.jiesuan" placeholder="是否结算" style="width: 35%;">
...
import {findByCode} from "/@/api/record/system/project";
