        ...
        <a-tabs type="card" v-model:activeKey="defaultTabsKey" @change="tabsChange"
          ...
          <a-tab-pane key="1" tab="普通纸张">
            <ul>
              ...
              <li>
                <a-checkbox v-model:checked="modelList['1'].variable.printForeign"
...
} from "/@/views/boozsoft/system/accvoucher/popup/printTemplate";
...
doc.autoTable({
  head: [['记账凭证', '', '', ''],
    ['核算单位：' + etcArr[0].unit, '', '凭证号：' + etcArr[0].number, ''],
    ['摘要', '科目', '借方', '贷方']],
  body: printList,
  // startY: 60,
