          ...
          <a-tab-pane key="" tab="标准模式">
            <ul>
              ...
              <li>
                ...
                <a-checkbox v-model:checked="formItems.printUser" style="width: 130px;text-align: left;">
                  打印制表人
                </a-checkbox>
                <a-checkbox v-model:checked="formItems.printTime" style="width: 190px;text-align: left;">
                  打印当前时间
                </a-checkbox>
                <a-checkbox v-model:checked="formItems.printBz" style="width: 130px;text-align: left;">
                  打印币种
                </a-checkbox>
              </li>
            </ul>
    ...
    <template #footer>
      <div style="height: 35px">
        <div style="float: right">
          ...
          <a-button @click="handleOk()" type="primary">直接打印
          </a-button>
        </div>
      </div>
    </template>
