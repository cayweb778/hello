        ...
        <a-tabs v-model:activeKey="activeKey" tabPosition="left" type="card">
          <a-tab-pane key="" tab="标准模式">
            <ul>
              ...
              <li>
                <span>对账币种：</span>
                <a-select v-model:value="bz" style="width: 350px;" allowClear>
              ...
              <li>
                <span>字号：</span>
                <a-select v-model:value="fontSize" style="width: 350px;">
...
const endDate: any = ref(moment(useCompanyOperateStoreWidthOut().getLoginDate, 'YYYY/MM/DD'));
const bz: any = ref('');
