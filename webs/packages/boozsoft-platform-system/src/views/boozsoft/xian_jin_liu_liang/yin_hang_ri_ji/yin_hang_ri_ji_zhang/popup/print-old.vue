            ...
            <ul>
              ...
              <li>
                ...
                <a-select
                  ...
                  :disabled="formItems.printKemu=='1'"
                >
                  <a-select-option
...
const [register, {closeModal, setModalProps}] = useModalInner((data) => {
  ...
  /*findAccPrintByAccIdAndMenuName({accId: defaultAdName.value, menuName: 'yhrjz'}).then(res => {
    if (res.length > 0) {
...
async function handleOk() {
  ...
  /*accPrint.value.menuName = 'yhrjz'
  accPrint.value.menuChName = '银行日记账'
