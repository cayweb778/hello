  ...
  <div class="nc-hr">
    <div class="nc-hr-top">
      <div class="nc-hrt-one">
        <span style="font-size: 30px;font-weight: bold;color: #1c6ca1"><BarChartOutlined style="font-size: 40px;" />&nbsp;&nbsp;报表中心</span>
...
import {SearchOutlined,SmileOutlined,HeartFilled,BarChartOutlined} from '@ant-design/icons-vue';
import {message, Input as AInput ,Select as ASelect,Popover as APopover,Steps,  DatePicker as ADatePicker} from "ant-design-vue";
import HomeRightBottom from './HomeRightBottom-Report.vue';
