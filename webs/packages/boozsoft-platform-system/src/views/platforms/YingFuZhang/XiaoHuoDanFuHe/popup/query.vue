    ...
    <div style="display: inline-flex;justify-content: space-between;width: 100%;">
      <div style="width: calc(100% - 150px);height: 100%;">
        <div style="text-align: center;padding: 10px 0 5px;">
          ...
          <span style="line-height:30px;font-size: 24px;color: #0096c7;font-weight: bold;">&ensp;采购到货单复核</span>
        </div>
...
function handleOk() {
  ...
  let map={
    ...
    apHexiaoAuto: formItems.value.apHexiaoAuto,
    apSourceFlag: formItems.value.apSourceFlag,
    apCheckFlag: formItems.value.apCheckFlag,
