    ...
    <div style="display: inline-flex;justify-content: space-between;width: 100%;">
      <div style="width: calc(100% - 150px);height: 100%;">
        <div style="text-align: center;padding: 10px 0 5px;">
          ...
          <span style="line-height:30px;font-size: 24px;color: #0096c7;font-weight: bold;">&ensp;收(退)款单列表</span>
        </div>
        <div class="nc-open-content">
          <div class="open-content-up">
            ...
            <div class="border-div">
              ...
              <div>
                <label style="width: 110px;">收款部门：</label>
                &nbsp;
                <a-select
...
const dataTypeList: any = ref([{title:'全部',value:'0'},{title:'收款单',value:'1'},{title:'退款单',value:'2'}])
const sup: any = ref('')
