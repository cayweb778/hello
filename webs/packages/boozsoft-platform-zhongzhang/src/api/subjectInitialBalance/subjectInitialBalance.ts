...
export const findByFunctionModule = defRouteApi(async (iyear) => {
  return {
    url: '/sys/subjectinitialBalance/findByFunctionModule?iyear=' + iyear,
    timeout: 100000000000,
    method: 'POST',
  };
});
...
export const ssph = defRouteApi(async (params) => {
  return {
    url: Api.ssph ,
    timeout: 100000000000,
    method: 'POST',params
...
export const newSsph = defRouteApi(async (params) => {
  return {
    url: '/sys/subjectinitialBalance/newSsph' ,
    timeout: 100000000000,
    method: 'POST',params
  };
});
