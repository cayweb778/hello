<template>
  <div class="bg-white mr-0 overflow-hidden">
    <div style="width: 100%;height: 50px;">
      <label style="font-size: 20px;line-height: 50px;margin-left: 20px;">支出功能分类</label>
...
import {saveDept,GetDeptTreeByFlag} from '/@/api/record/group/expenditure-class'
...
async function fetch() {
  let deptTree = await GetDeptTreeByFlag()
