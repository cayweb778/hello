<template>
  ...
  >
    <template #title>
      <div style="display: flex;" class="vben-basic-title">
        <span style="line-height:40px;font-size: 28px;">
          <PlusCircleOutlined style="font-size: 34px;font-weight: bold"/>&nbsp;&nbsp;增减方式
        </span>
      </div>
    ...
    <div
      ...
      style="height: 100%"
    >
      <div class="open-content-up" style="text-align: center;">
...
import {getDeptList, GetDeptTreeByFlag} from '/@/api/record/group/fa-ac'

import {useMessage} from "/@/hooks/web/useMessage";
import {getMaxCode} from "/@/api/record/system/zf-class";
