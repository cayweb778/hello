    ...
    <div class="app-container">
      ...
      <PageWrapper dense content-full-height fixed-height content-class="flex">
        <div v-if="!isShowTree"
             ...
             class="w-1/4 xl:w-1/5"></div>
        <DeptTree v-if="isShowTree" class="w-1/4 xl:w-1/5" @select="handleSelect"
        ...
        <div style="width: calc(100% - 250px); float: right;margin-left: 5px;">
          <BasicTable class="w-3/4 xl:w-4/5"
            ...
            <template #peopertyId="{ record }">
              <span style="float: left" v-if="record.peopertyId!='' && record.peopertyId!=null">{{record.peopertyId}}</span>
            </template>
            ...
            <template #faDepMethod="{ record }">
              <span style="float: left" v-if="record.faDepMethod!='' && record.faDepMethod!=null">{{jiti(record)}}</span>
            </template>
