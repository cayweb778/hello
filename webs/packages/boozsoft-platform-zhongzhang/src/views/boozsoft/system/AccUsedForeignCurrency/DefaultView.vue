...
const useTableParams = useTable({
  api: useRouteApi(findAllApiAcc,{schemaName:pageParameter.value.tenantId}),
...
const [registerTable, {reload, setTableData, getDataSource, setColumns, getColumns,getSelectRows}]=useTableParams
...
import {deleteCurrencyData, initBasisTabAccoutData} from "/@/api/record/system/financial-settings";
import {useRouteApi} from "/@/utils/boozsoft/datasource/datasourceUtil";
import {findAllApiAcc, saveApiAcc} from "/@/api/boozsoft/group/UsedForeignCurrency";
