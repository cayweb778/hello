...
const [register, { closeModal }] = useModalInner(async (data) => {
  ...
  // }
    ...
    formItems.controlled=data.data.data.controlled;
    ...
    formItems.bdaybook=data.data.data.bdaybook;
    formItems.igrade=data.data.data.igrade;
    formItems.uniqueAccStandard=data.data.data.uniqueAccStandard;
    formItems.superiorCcode=data.data.data.superiorCcode;
    formItems.templateId=data.data.data.templateId;
    formItems.lowerControl=data.data.data.lowerControl;
  console.log(data.data.data.lowerControl)
    formItems.fuzhuControl=data.data.data.fuzhuControl;
    formItems.uniqueAccStandardName=data.data.data.uniqueAccStandardName;
    formItems.templateName=data.data.data.templateName;
    ...
    formItems.fuzhu=data.data.data.fuzhu;
    formItems.yusuan=data.data.data.yusuan;
    formItems.superCodeBend=data.data.data.superCodeBend;
    formItems.oldCcode=data.data.data.oldCcode;
    formItems.closeflag=data.data.data.closeflag;
    formItems.orgUnique=data.data.data.orgUnique;
    formItems.ysYsly=data.data.data.ysYsly;
    formItems.ysZcgnfl=data.data.data.ysZcgnfl;
    formItems.ysZfzcjjfl=data.data.data.ysZfzcjjfl;
    formItems.ysBmzcjjfl=data.data.data.ysBmzcjjfl;
    formItems.cassItem=data.data.data.cassItem;
    formItems.bstock=data.data.data.bstock;
// 获取所有计算单位
...
async function getNewCcode(code,val) {
  if(code!=='不存在'){
    ...
    if(val!=undefined){
      // 编码_级次
      let newccode:any =await findByOrgLowerMaxCodeNum(orgUnique.value,val,code_length,iyear.value);
