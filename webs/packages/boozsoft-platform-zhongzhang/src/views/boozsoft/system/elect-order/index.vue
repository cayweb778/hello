<template>
  <div class="app-container">
    ...
    <div class="app-container-head">
      ...
      <span style="    margin-left: 10px;"><b>电子回单</b></span>
...
import {getElectOrderList, deleteElectOrder, saveElectOrder} from '/@/api/record/system/elect-order'
...
const CrudApi = {
  ...
  columns: [
    ...
    {
      title: '回单日期',
      dataIndex: 'electOderDate',
      ellipsis: true
    },
    {
      title: '回单类型',
      dataIndex: 'electOderType',
      ellipsis: true
    },
    {
      title: '交易类型',
      dataIndex: 'electOderTrans',
      ellipsis: true
    },
    {
      title: '金额',
...
const del = async(data:any) => {
  await deleteElectOrder(data)
  alert('删除成功！')
  reload()
}

async function saveData(data:any) {
  await saveElectOrder(data)
  reload()
}
