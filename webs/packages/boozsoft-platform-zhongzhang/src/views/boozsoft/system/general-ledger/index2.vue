  ...
  <div>
          ...
          <div style="width: 40%;padding-top:15px;">
            ...
            <div style="margin-top: 10px;margin-left: 5px;">
              ...
              <a-select
                ...
                style="width: 250px;font-size: 14px;border-color: #d2cfcf;"
              ...
              &emsp;
              本位币：<span style="font-weight: bold">{{ bzName }} </span>
            </div>
          </div>
          <div style="width: 60%;float: right;margin-top: -77px;">
            <span style="font-size: 24px;color: #0096c7;font-weight: bold;">{{ titleName }}总账</span>
            ...
            <span style="display: block;color: black;font-size: 14px;">期间：{{ pageParameter.strDate }}~{{ pageParameter.endDate }}
            <span style="float: right;margin-top: 10px;">
              <div>
                ...
                <a-popover class="ant-btn-default" placement="bottom">
                  <template #content>
                    <span class="group-btn-span-special2" @click="onChangeSwitch('J')" :style="{backgroundColor: (pageParameter.queryMark==='J')?'#e3e0e0':'white',cursor: 'pointer',width: '170px'}">&emsp;<OrderedListOutlined :style="{ fontSize: '13px' }"/>金额式&nbsp;</span><br/>
                    <span class="group-btn-span-special2" @click="onChangeSwitch('SJ')" :style="{backgroundColor: (pageParameter.queryMark==='SJ')?'#e3e0e0':'white',cursor: 'pointer',width: '170px'}">&emsp;<OrderedListOutlined :style="{ fontSize: '13px' }"/>数量金额式&nbsp;</span><br/>
                    <span class="group-btn-span-special2" @click="onChangeSwitch('WJ')" :style="{backgroundColor: (pageParameter.queryMark==='WJ')?'#e3e0e0':'white',cursor: 'pointer',width: '170px'}">&emsp;<OrderedListOutlined :style="{ fontSize: '13px' }"/>外币金额式&nbsp;</span><br/>
                    <span class="group-btn-span-special2" @click="onChangeSwitch('SWJ')" :style="{backgroundColor: (pageParameter.queryMark==='SWJ')?'#e3e0e0':'white',cursor: 'pointer',width: '170px'}">&emsp;<OrderedListOutlined :style="{ fontSize: '13px' }"/>数量外币式&nbsp;</span><br/>
                  </template>
                  <a-button>
    ...
    <div class="app-container" style="margin-top: -50px;">
      <div class="app-container-bottom" :style="{height: (windowHeight+60)+'px'}">
        <div v-if="pageMode=='1'" style="display: inline-block;height: 100%; float: left;"
             :style="showTree?{width: 'calc(100% - 186px)'}:{width: '99.8%'}">
          <BasicTable
            ref="tableRef"
            ...
            <template #summary>
              <TableSummary fixed>
                <TableSummaryRow style="background-color: #cccccc;" v-if="pageParameter.queryMark=='J'">
                  <TableSummaryCell class="nc-summary" :index="0" :align="'left'" :colSpan="3" style="border-right: none;font-weight: bold;">合计</TableSummaryCell>
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;">{{summaryTotals.sjmoney}}</TableSummaryCell>
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;">{{summaryTotals.sdmoney}}</TableSummaryCell>
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;" />
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;">{{summaryTotals.symoney}}</TableSummaryCell>
                </TableSummaryRow>

                <TableSummaryRow style="background-color: #cccccc;" v-if="pageParameter.queryMark=='SJ'">
                  <TableSummaryCell class="nc-summary" :index="0" :align="'left'" :colSpan="4" style="border-right: none;font-weight: bold;">合计</TableSummaryCell>
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;">{{summaryTotals.sjnum}}</TableSummaryCell>
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;">{{summaryTotals.sjmoney}}</TableSummaryCell>
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;">{{summaryTotals.sdnum}}</TableSummaryCell>
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;">{{summaryTotals.sdmoney}}</TableSummaryCell>
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;" />
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;">{{summaryTotals.synum}}</TableSummaryCell>
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;">{{summaryTotals.symoney}}</TableSummaryCell>
                </TableSummaryRow>

                <TableSummaryRow style="background-color: #cccccc;" v-if="pageParameter.queryMark=='WJ'">
                  <TableSummaryCell class="nc-summary" :index="0" :align="'left'" :colSpan="4" style="border-right: none;font-weight: bold;">合计</TableSummaryCell>
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;">{{summaryTotals.sjwb}}</TableSummaryCell>
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;">{{summaryTotals.sjmoney}}</TableSummaryCell>
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;">{{summaryTotals.sdwb}}</TableSummaryCell>
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;">{{summaryTotals.sdmoney}}</TableSummaryCell>
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;" />
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;">{{summaryTotals.sywb}}</TableSummaryCell>
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;">{{summaryTotals.symoney}}</TableSummaryCell>
                </TableSummaryRow>

                <TableSummaryRow style="background-color: #cccccc;" v-if="pageParameter.queryMark=='SWJ'">
                  <TableSummaryCell class="nc-summary" :index="0" :align="'left'" :colSpan="5" style="border-right: none;font-weight: bold;">合计</TableSummaryCell>
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;">{{summaryTotals.sjnum}}</TableSummaryCell>
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;">{{summaryTotals.sjwb}}</TableSummaryCell>
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;">{{summaryTotals.sjmoney}}</TableSummaryCell>
                  <TableSummaryCell class="nc-summary" :index="0" :align="'right'" style="border-right: none;">{{summaryTotals.sdnum}}</TableSummaryCell>
          ...
          <div class="pagination-text" :style="{top: (pageParameter.queryMark=='J'?windowHeight+62:windowHeight+85)+'px'}" v-show="showPageNumber">
...
import {
  ...
  EditFilled,
  PieChartFilled,
  FilterFilled,CheckOutlined,EditOutlined,SearchOutlined,CaretDownOutlined
...
import Query from "/@/views/boozsoft/system/general-ledger/popup/query.vue";
...
import {findAll, findAllDept,   sheetDate, sheetDateOne,findCusAll} from "/@/api/record/generalLedger/data";
...
function fetchSuccess(data) {
  ...
  if(data.items.length<50){
    for (let i =  data.items.length; i < 50; i++) {
      data.items.push({number: data.items.length+1,num:null,sjnum:0,sjwb:0,sjmoney:0,sdnum:0,sdwb:0,sdmoney:0,synum:0,sywb:0,symoney:0})
    }
  }
...
const calculateTotal = (datalist) => {
  let list = datalist.filter(a=>a.num!='')
  if (list.length == 0){
    summaryTotals.value = {}
    return false;
  }
  let sjnum=0,sjwb=0,sjmoney=0,sdnum=0,sdwb=0,sdmoney=0,synum=0,sywb=0,symoney=0
  for (let i = 0; i < list.length; i++) {
    const e = list[i];
    sjnum += parseFloat(e.sjnum || '0')
    sjwb += parseFloat(e.sjwb || '0')
    sjmoney += parseFloat(e.sjmoney || '0')
    sdnum += parseFloat(e.sdnum || '0')
    sdwb += parseFloat(e.sdwb || '0')
    sdmoney += parseFloat(e.sdmoney || '0')
    synum += parseFloat(e.synum || '0')
    sywb += parseFloat(e.sywb || '0')
    symoney += parseFloat(e.symoney || '0')
  }
  summaryTotals.value={
    sjnum: formatData(sjnum),
    sjwb: formatData(sjwb),
    sjmoney: formatData(sjmoney),
    sdnum: formatData(sdnum),
    sdwb: formatData(sdwb),
    sdmoney: formatData(sdmoney),
    synum: formatData(synum),
    sywb: formatData(sywb),
...
function formatData(data:any){
  if(data==null || data==''||parseFloat(data)==0){return }
  let str = ""
  if(data){
    // 千分位保留2位小数
...
const onChangeSwitch = async(v)=>{ // 动态列
  styleName.value = showStyle2.value.filter(o=> o.value === v)[0].name
...
const loadPage = async(map)=>{
  ...
  pageParameter.maxKm = data.maxKm
  ...
  pageParameter.queryMark = data.showStyle
  styleName.value = showStyle.value.filter(o=> o.value = data.showStyle)[0].name
...
async function onlySheetExport() {
  ...
  await useRouteApi(sheetDateOne, {schemaName: database})(pageParameter)
    .then(item=>{
...
async function companyExportView() {
  ...
  await useRouteApi(sheetDate, {schemaName: database})(pageParameter)
    .then(item=>{
      const sheet =[]
