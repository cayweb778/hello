    ...
    <div class="app-container">
      ...
      <div class="app-container-neck">
        <div style="float: left;">
          <span>所属组织：</span>
          <a-select v-model:value="pageParameter.accGroup" @change="reload"
...
import {
  ...
  deleteList,
  delAcclotList,
  editGroupAccuracyOverTime, GroupAccuracyOverTime, saveGroupAccuracyOverTime, editAcclotStateList
...
onMounted(async () => {
  ...
  if(organizeList.value.length>0){
    pageParameter.accGroup=organizeList.value[0].uniqueCode
  }
  reload()
})
