...
const CrudApi = {
  ...
  columns: [
    ...
    // { title: '部门ID', dataIndex: 'deptId', ellipsis: true },
    {
      ...
      dataIndex: 'jigouName',
      ellipsis: true,
      sorter: (a, b) => a.jigouName.length - b.jigouName.length,
    },
    {
      title: '角色',
      dataIndex: 'roleList',
      ...
      ellipsis: true,
      sorter: (a, b) => a.roleList.length - b.roleList.length,
    },
    {
      title: '真实名字',
      dataIndex: 'realName',
...
<template>
  <div class="app-container">
    <div class="app-container-head">
      ...
      <span style="    margin-left: 10px;"><b>员工档案</b></span>
      ...
      <div class="ant-btn-group" data-v-a1ccd506="" style="float: right">
        <button type="button" class="ant-btn" ant-click-animating-without-extra-node="false"  @click="openEditPage(true, {data: val})"
          ><span>新建</span></button
        >
      ...
      <template #action="{ record }">
        <a-popover placement="bottom">
          <template slot="content">
            <div class="el-radio">
              <a title="编辑" style="color: #5f375c"
                >&nbsp;<b><i class="fa fa-pencil-square-o" aria-hidden="true" />&emsp;编&emsp;辑</b
                >&emsp;</a
              >
            </div>
            <br />
            <div class="el-radio">
              <a title="修改密码" style="color: #5f375c"
                >&nbsp;<b><i class="fa fa-key" aria-hidden="true" />&emsp;修改密码</b></a
              >
            </div>
            <div class="el-radio">
              <a title="删除" style="color: #5f375c"
                >&nbsp;<b><i class="fa fa-trash" aria-hidden="true" />&nbsp;&emsp;删&emsp;除</b
                >&emsp;</a
              >
            </div>
          </template>
