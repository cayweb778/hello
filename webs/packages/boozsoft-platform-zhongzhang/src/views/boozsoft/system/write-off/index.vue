...
<script setup lang="ts">
  ...
  import {
    findAllAccvoucherHexiao, autoWriteOff, saveManualWriteOff
  ...
  const CrudApi = reactive({
    list: useRouteApi(findAllAccvoucherHexiao,{schemaName:manipulateDbName.value}),
