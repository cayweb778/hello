...
import {findAllAccvoucherTreeXianjin} from "/@/api/record/system/accvoucher";
...
async function fetch2() {
  let res = await useRouteApi(findAllAccvoucherTreeXianjin, {schemaName: props.database})({yearMonth: `${compParameter.value.year}-${compParameter.value.dayMonth}`})
