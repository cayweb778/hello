  ...
  >
    <template #title>
      <div style="height: 30px;width: 100%;background-color: #5f375c;color: white;line-height: 30px;">
        ...
        <span style="font-size: 13px">现金银行</span>
      </div>
    </template>
    <div style="display: inline-flex;justify-content: space-between;width: 100%;">
      <div style="width: calc(100% - 150px);height: 100%;">
        <div style="text-align: center;padding: 10px 0 5px;">
          ...
          <span style="line-height:30px;font-size: 24px;color: #0096c7;font-weight: bold;">&ensp;现金日记账</span>
        </div>
        <div
          ...
          <div class="open-content-up">
            ...
            <div class="border-div">
              ...
              <div style="margin-left: 14px;">
                <a-checkbox v-model:checked="formItems.printUser" style="width: 130px"> 打印人 </a-checkbox>
                <a-checkbox v-model:checked="formItems.thisDate" style="width: 130px"> 打印时间 </a-checkbox>
              </div>
            </div>
          </div>
        </div>
