    ...
    <div class="app-container-top">
      <div class="app-container-head"><img :src="getThisIndexImg()" class="container-head-img"
        ...
        <div class="container-head-title">
          <b class="noneSpan">现金余额表</b>
        </div>
        <!--      <div class="container-head-title" style="float: none;text-align: center;width: 100%;">
                <b class="noneSpan">现金余额表</b>
              </div>-->
...
import {
  findAccountByCashYue,
  findAccountByCashYueLeiji,
  findAccountByCashYueQichu
...
const lanMuData = {'accId': '', 'menuName': '现金余额表', 'type': '', objects: '',username:useUserStoreWidthOut().getUserInfo.username}
// 表格参数
...
async function findAll(){
  const res = await useRouteApi(findAccountByCashYue, {schemaName: database})(pageParameter)
  ...
  const qichuList = await useRouteApi(findAccountByCashYueQichu, {schemaName: database})(pageParameter)
  const leijiList = await useRouteApi(findAccountByCashYueLeiji, {schemaName: database})(pageParameter)
  const list:any = []
  const sumItem:any = {}
  sumItem.ccode = '合计'
  sumItem.qcNum = '0'
