...
} from "/@/api/yin_hang_ri_ji_zhang/yin_hang_ri_ji_zhang";
  ...
  ColumnsModel = {
    J:[
      ...
      },
      {
        ...
        isShow: thisIsShow(1),
        width: thisWidth(1),
        // customRender: ({ record }) => initDirection(record.idate,1)
        align: thisAlign(1),
      ...
      },
      {
        ...
        isShow: thisIsShow(2),
        width: thisWidth(2),
        // customRender: ({ record }) => initDirection(record.pzNum,2)
        align: thisAlign(2),
      ...
      },
      {
        ...
        isShow: thisIsShow(3),
        width: thisWidth(3),
        // customRender: ({ record }) => initDirection(record.zhaiyao,3)
        align: thisAlign(3),
      ...
      },
      {
        ...
        isShow: thisIsShow(4),
        width: thisWidth(4),
        // customRender: ({ record }) => initDirection(record.dfkemu,9)
        align: thisAlign(4),
      ...
      },
      {
        ...
        isShow: thisIsShow(5),
        width: thisWidth(5),
        // customRender: ({ record }) => initDirection(record.dfUnit,10)
        align: thisAlign(5),
        slots: {customRender: 'dfUnit'}
      },
      {
        title: thisName(6),
        dataIndex: 'jiesuan',
        ...
        isShow: thisIsShow(6),
        width: thisWidth(6),
        // customRender: ({ record }) => initDirection(record.jiesuan,4)
        align: thisAlign(6),
      ...
      },
      {
        ...
        isShow: thisIsShow(7),
        width: thisWidth(7),
        // customRender: ({ record }) => initDirection(record.piaohao,5)
        align: thisAlign(7),
        slots: {customRender: 'piaohao'},
      },
      {
        title: thisName(8),
        isShow: thisIsShow(8),
        ...
        children: [
          {
            ...
            // customRender: ({ record }) => initDirection(record.jieMoney,'6-1')
            align: thisAlign('8-1'),
        ...
        children: [
          {
            ...
            dataIndex: 'daiMoney',
            key: 'daiMoney',
            isShow: thisIsShow('9-1'),
            width: thisWidth('9-1'),
            // slots: { customRender: thisAlign('7-1') },
            // customRender: ({ record }) => initDirection(record.daiMoney,'7-1')
            align: thisAlign('9-1'),
        ...
        children: [
          {
            ...
            dataIndex: 'fangxiang',
            key: 'fangxiang',
            isShow: thisIsShow('10-1'),
            width: thisWidth('10-1'),
            // slots: { customRender: thisAlign('8-1') },
            // customRender: ({ record }) => initDirection(record.fangxiang,'8-1')
            align: thisAlign('10-1'),
          ...
          },
          {
            ...
            dataIndex: 'yueMoney',
            key: 'yueMoney',
            isShow: thisIsShow('10-2'),
            width: thisWidth('10-2'),
            // slots: { customRender: thisAlign('8-2') },
            // customRender: ({ record }) => initDirection(record.yueMoney,'8-2')
            align: thisAlign('10-2'),
        ...
        children: [
          {
            ...
            // customRender: ({ record }) => initDirection(record.jiewb,'6-2')
            align: thisAlign('8-2'),
        ...
        children: [
          {
            ...
            dataIndex: 'daiwb',
            key: 'daiwb',
            isShow: thisIsShow('9-2'),
            width: thisWidth('9-2'),
            // slots: { customRender: thisAlign('7-2') },
            // customRender: ({ record }) => initDirection(record.daiwb,'7-2')
            align: thisAlign('9-2'),
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            dataIndex: 'yuewb',
            key: 'yuewb',
            isShow: thisIsShow('10-3'),
            width: thisWidth('10-3'),
            // slots: { customRender: thisAlign('8-3') },
            // customRender: ({ record }) => initDirection(record.yueMoney,'8-3')
            align: thisAlign('10-3'),
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            width: thisWidth('10-3'),
            // slots: { customRender: thisAlign('8-3') },
            // customRender: ({ record }) => initDirection(record.yuewb,'8-3')
            align: thisAlign('10-3'),
            slots: {customRender: 'yuewb'}
          }
        ],
