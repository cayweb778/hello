<template>
  <div class="nc-hr">
    ...
    <div class="nc-hr-middle">
      <div>
        <Button class="ant-btn-me">查询</Button>
        ...
        <Button class="ant-btn-me" style="border-left: none;" >退出</Button>
      </div>
      <div>
...
<style src="src/assets/styles/alone-basic-table.less" lang="less" scoped></style>
