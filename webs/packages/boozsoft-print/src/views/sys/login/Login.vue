<template>
    ...
    <div :class="prefixCls" class="asdsad relative w-full h-full px-4" :style="bgStyle">
      <!--    <AppLocalePicker
...
export default defineComponent({
  ...
  setup() {
    ...
    const nc_logo_png=new URL('/ncauth/img/login/nc_logo.png', import.meta.url).href;
    const booz_nc_logo_png=new URL('/ncauth/img/login/boozsoft_logo.png', import.meta.url).href;
    const bgStyle='background-image: url(\''+new URL('/ncauth/img/login/background-login.png', import.meta.url).href+'\')'
    return {
      nc_logo_png,
      booz_nc_logo_png,
      bgStyle,
