...
export const menus = [
  ...
  */
  ...
  createPlatformMenu({ id: useId(139), path: '/kc-Jgzx-list', component: '/boozsoft/stock/stock-jhzx-list/index', componentName:'JhzxList', parentId: useId(237), name: '拣货装箱单列表' }),
